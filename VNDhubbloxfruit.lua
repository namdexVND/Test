loadstring(game:HttpGet("https://raw.githubusercontent.com/namdexVND/Test/refs/heads/main/fight.txt", true))()
...
-- 1. Load thư viện Fluent-Modded
local Fluent = loadstring(game:HttpGet("https://github.com/StyearX/Fluent-Modded/releases/download/Fluent/FluentPro"))()

-- 2. Đăng ký Theme Cyber Hacker
Fluent:RegisterCustomTheme("CyberHacker", {
    Accent = Color3.fromRGB(0, 255, 60),      -- Xanh Neon
    AcrylicMain = Color3.fromRGB(15, 15, 15), -- Nền đen nhám
    Text = Color3.fromRGB(220, 255, 220),     -- Chữ xanh nhạt
    ...
    Shine = {
        ...
        ColorSequence = ColorSequence.new({
            ColorSequenceKeypoint.new(0, Color3.fromRGB(0, 60, 20)),
            ColorSequenceKeypoint.new(0.5, Color3.fromRGB(0, 255, 60)),
            ColorSequenceKeypoint.new(1, Color3.fromRGB(0, 60, 20)),
        }),
    },
})
...
-- 4. Tạo Nút Toggle (Floating Button)
...
ScreenGui.Name = "VNDHubToggle"

ImageButton.Parent = ScreenGui
ImageButton.BackgroundColor3 = Color3.fromRGB(30, 30, 30)
ImageButton.BorderSizePixel = 0
ImageButton.Position = UDim2.fromOffset(50, 100) 
ImageButton.Size = UDim2.fromOffset(50, 50)
ImageButton.Image = "http://www.roblox.com/asset/?id=81175347135879"
...
UserInputService.InputChanged:Connect(function(input)
    if dragging and (input.UserInputType == Enum.UserInputType.MouseMovement or input.UserInputType == Enum.UserInputType.Touch) then
        ...
        ImageButton.Position = UDim2.new(0, startPos.X.Offset + delta.X, 0, startPos.Y.Offset + delta.Y)
    end
end)
...
local FruitAndRaid = Window:AddTab({Title = "Fruit/Raid", Icon = "lucide/apple"})
