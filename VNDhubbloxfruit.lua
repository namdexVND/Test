...
-- 3. Tạo Nút Toggle (Floating Button)
...
ImageButton.Draggable = false -- Tắt cái mặc định để tự dùng logic riêng
ImageButton.Name = "ToggleButton"

UICorner.CornerRadius = UDim.new(0, 10)
UICorner.Parent = ImageButton

-- 4. Logic Drag & Drop (Đa nền tảng)
...
-- 5. Sự kiện Click (Bật/Tắt Menu)
ImageButton.Activated:Connect(function()
    if not isDragging then
        Window:Minimize() -- Hàm chuẩn của Fluent để ẩn/hiện menu
    end
end)
