...
local u8 = false
local u9 = UDim2.new(0, 40, 0, 40)
local u10 = UDim2.new(0, 30, 0, 30)
local u11 = TweenInfo.new(0.25, Enum.EasingStyle.Quad, Enum.EasingDirection.Out)
local u12 = false
local v13 = _TweenService
local u14 = _TweenService.Create(v13, _Frame, u11, {BackgroundTransparency = 0.25})
local v15 = _TweenService
local u16 = _TweenService.Create(v15, _Frame, u11, {BackgroundTransparency = 0})

_TextButton.MouseButton1Down:Connect(function()
    if u8 then
        _TweenService:Create(_ImageLabel, u11, {Size = u9}):Play()
    else
        _TweenService:Create(_ImageLabel, u11, {Size = u10}):Play()
    end
    ...
    _VirtualInputManager:SendKeyEvent(true, 'LeftControl', false, game)
end)

local u17 = loadstring(game:HttpGet('https://github.com/dawid-scripts/Fluent/releases/latest/download/main.lua'))()
...
local v18 = u17:CreateWindow({
    Title = 'Banana Cat Hub-Blox Fruit  [ Free ]',
    SubTitle = 'by Tu\u{1ea5}n Anh IOS',
    TabWidth = 160,
...
function CheckLevel()
    ...
    if Sea3 then
        ...
        elseif (_Value < 2425 or _Value > 2449) and SelectMonster ~= 'Snow Demon' then
            if (_Value < 2450 or _Value > 2474) and SelectMonster ~= 'Isle Outlaw' then
                if (_Value < 2475 or _Value > 2499) and SelectMonster ~= 'Island Boy' then
                    if (_Value < 2500 or _Value > 2524) and SelectMonster ~= 'Sun-kissed Warrior' then
                        if (_Value < 2525 or _Value > 2549) and SelectMonster ~= 'Isle Champion' then
                            if (_Value < 2550 or _Value > 2574) and SelectMonster ~= 'Serpent Hunter' then
                                if _Value >= 2575 and _Value <= 2650 or SelectMonster == 'Skull Slayer' then
                                    Ms = 'Skull Slayer'
...
function UpdateIslandESP()
    local v24, v25, v26 = pairs(game:GetService('Workspace')._WorldOrigin.Locations:GetChildren())
    ...
    while true do
        ...
        pcall(function()
            if IslandESP then
                if u27.Name ~= 'Sea' then
                    if u27:FindFirstChild('NameEsp') then
                        u27.NameEsp.TextLabel.Text = u27.Name .. '   \n' .. round((game:GetService('Players').LocalPlayer.Character.Head.Position - u27.Position).Magnitude / 3) .. ' Distance'
                    else
                        local _BillboardGui = Instance.new('BillboardGui', u27)

                        _BillboardGui.Name = 'NameEsp'
                        _BillboardGui.ExtentsOffset = Vector3.new(0, 1, 0)
                        _BillboardGui.Size = UDim2.new(1, 200, 1, 30)
                        _BillboardGui.Adornee = u27
            ...
            elseif u27:FindFirstChild('NameEsp') then
                u27:FindFirstChild('NameEsp'):Destroy()
            end
        end)
    end
end
...
local function u32(p31)
    return math.floor(tonumber(p31) + 0.5)
end

Number = math.random(1, 1000000)

function UpdatePlayerChams()
    local v33, v34, v35 = pairs(game:GetService('Players'):GetChildren())
            ...
            if not isnil(u36.Character) then
                if ESPPlayer then
                    if isnil(u36.Character.Head) or u36.Character.Head:FindFirstChild('NameEsp' .. Number) then
                        u36.Character.Head['NameEsp' .. Number].TextLabel.Text = u36.Name .. ' | ' .. u32((game:GetService('Players').LocalPlayer.Character.Head.Position - u36.Character.Head.Position).Magnitude / 3) .. ' Distance\nHealth : ' .. u32(u36.Character.Humanoid.Health * 100 / u36.Character.Humanoid.MaxHealth) .. '%'
                    else
                        ...
                        _TextLabel2.Text = u36.Name .. ' \n' .. u32((game:GetService('Players').LocalPlayer.Character.Head.Position - u36.Character.Head.Position).Magnitude / 3) .. ' Distance'
...
function UpdateChestChams()
    ...
    while true do
        ...
        pcall(function()
            if string.find(u42.Name, 'Chest') then
                if ChestESP then
                    if string.find(u42.Name, 'Chest') then
                        if u42:FindFirstChild('NameEsp' .. Number) then
                            u42['NameEsp' .. Number].TextLabel.Text = u42.Name .. '   \n' .. u32((game:GetService('Players').LocalPlayer.Character.Head.Position - u42.Position).Magnitude / 3) .. ' Distance'
                        else
                            local _BillboardGui3 = Instance.new('BillboardGui', u42)

                            _BillboardGui3.Name = 'NameEsp' .. Number
                            _BillboardGui3.ExtentsOffset = Vector3.new(0, 1, 0)
                            _BillboardGui3.Size = UDim2.new(1, 200, 1, 30)
                            _BillboardGui3.Adornee = u42
...
function UpdateDevilChams()
    local v45, v46, v47 = pairs(game.Workspace:GetChildren())
    ...
    while true do
        ...
        pcall(function()
            if DevilFruitESP then
                if string.find(u48.Name, 'Fruit') then
                    if u48.Handle:FindFirstChild('NameEsp' .. Number) then
                        u48.Handle['NameEsp' .. Number].TextLabel.Text = u48.Name .. '   \n' .. u32((game:GetService('Players').LocalPlayer.Character.Head.Position - u48.Handle.Position).Magnitude / 3) .. ' Distance'
                    else
                        local _BillboardGui4 = Instance.new('BillboardGui', u48.Handle)

                        _BillboardGui4.Name = 'NameEsp' .. Number
                        _BillboardGui4.ExtentsOffset = Vector3.new(0, 1, 0)
                        _BillboardGui4.Size = UDim2.new(1, 200, 1, 30)
                        _BillboardGui4.Adornee = u48.Handle
                        ...
                        _TextLabel4.Text = u48.Name .. ' \n' .. u32((game:GetService('Players').LocalPlayer.Character.Head.Position - u48.Handle.Position).Magnitude / 3) .. ' Distance'
                    end
                end
            elseif u48.Handle:FindFirstChild('NameEsp' .. Number) then
                u48.Handle:FindFirstChild('NameEsp' .. Number):Destroy()
            end
        end)
    end
end
function UpdateFlowerChams()
    local v51, v52, v53 = pairs(game.Workspace:GetChildren())
    ...
    while true do
        ...
        pcall(function()
            if u54.Name == 'Flower2' or u54.Name == 'Flower1' then
                if FlowerESP then
                    if u54:FindFirstChild('NameEsp' .. Number) then
                        u54['NameEsp' .. Number].TextLabel.Text = u54.Name .. '   \n' .. u32((game:GetService('Players').LocalPlayer.Character.Head.Position - u54.Position).Magnitude / 3) .. ' Distance'
                    else
                        local _BillboardGui5 = Instance.new('BillboardGui', u54)

                        _BillboardGui5.Name = 'NameEsp' .. Number
                        _BillboardGui5.ExtentsOffset = Vector3.new(0, 1, 0)
                        _BillboardGui5.Size = UDim2.new(1, 200, 1, 30)
                        _BillboardGui5.Adornee = u54
                        ...
                        if u54.Name == 'Flower1' then
                            _TextLabel5.Text = 'Blue Flower' .. ' \n' .. u32((game:GetService('Players').LocalPlayer.Character.Head.Position - u54.Position).Magnitude / 3) .. ' Distance'
                            _TextLabel5.TextColor3 = Color3.fromRGB(0, 0, 255)
                        end
                        if u54.Name == 'Flower2' then
                            _TextLabel5.Text = 'Red Flower' .. ' \n' .. u32((game:GetService('Players').LocalPlayer.Character.Head.Position - u54.Position).Magnitude / 3) .. ' Distance'
                            _TextLabel5.TextColor3 = Color3.fromRGB(255, 0, 0)
                        end
                    end
                elseif u54:FindFirstChild('NameEsp' .. Number) then
                    u54:FindFirstChild('NameEsp' .. Number):Destroy()
                end
            end
        end)
    end
...
function UpdateRealFruitChams()
    local v57, v58, v59 = pairs(game.Workspace.AppleSpawner:GetChildren())
        ...
        if v60:IsA('Tool') then
            if RealFruitESP then
                if v60.Handle:FindFirstChild('NameEsp' .. Number) then
                    v60.Handle['NameEsp' .. Number].TextLabel.Text = v60.Name .. ' ' .. u32((game:GetService('Players').LocalPlayer.Character.Head.Position - v60.Handle.Position).Magnitude / 3) .. ' Distance'
                else
                    local _BillboardGui6 = Instance.new('BillboardGui', v60.Handle)

                    _BillboardGui6.Name = 'NameEsp' .. Number
                    _BillboardGui6.ExtentsOffset = Vector3.new(0, 1, 0)
                    _BillboardGui6.Size = UDim2.new(1, 200, 1, 30)
                    _BillboardGui6.Adornee = v60.Handle
                    ...
                    _TextLabel6.Text = v60.Name .. ' \n' .. u32((game:GetService('Players').LocalPlayer.Character.Head.Position - v60.Handle.Position).Magnitude / 3) .. ' Distance'
                end
    ...
    local v63, v64, v65 = pairs(game.Workspace.PineappleSpawner:GetChildren())
        ...
        if v66:IsA('Tool') then
            if RealFruitESP then
                if v66.Handle:FindFirstChild('NameEsp' .. Number) then
                    v66.Handle['NameEsp' .. Number].TextLabel.Text = v66.Name .. ' ' .. u32((game:GetService('Players').LocalPlayer.Character.Head.Position - v66.Handle.Position).Magnitude / 3) .. ' Distance'
                else
                    local _BillboardGui7 = Instance.new('BillboardGui', v66.Handle)

                    _BillboardGui7.Name = 'NameEsp' .. Number
                    _BillboardGui7.ExtentsOffset = Vector3.new(0, 1, 0)
                    _BillboardGui7.Size = UDim2.new(1, 200, 1, 30)
                    _BillboardGui7.Adornee = v66.Handle
                    ...
                    _TextLabel7.Text = v66.Name .. ' \n' .. u32((game:GetService('Players').LocalPlayer.Character.Head.Position - v66.Handle.Position).Magnitude / 3) .. ' Distance'
                end
    ...
    local v69, v70, v71 = pairs(game.Workspace.BananaSpawner:GetChildren())
        ...
        if v72:IsA('Tool') then
            if RealFruitESP then
                if v72.Handle:FindFirstChild('NameEsp' .. Number) then
                    v72.Handle['NameEsp' .. Number].TextLabel.Text = v72.Name .. ' ' .. u32((game:GetService('Players').LocalPlayer.Character.Head.Position - v72.Handle.Position).Magnitude / 3) .. ' Distance'
                else
                    local _BillboardGui8 = Instance.new('BillboardGui', v72.Handle)

                    _BillboardGui8.Name = 'NameEsp' .. Number
                    _BillboardGui8.ExtentsOffset = Vector3.new(0, 1, 0)
                    _BillboardGui8.Size = UDim2.new(1, 200, 1, 30)
                    _BillboardGui8.Adornee = v72.Handle
                    ...
                    _TextLabel8.Text = v72.Name .. ' \n' .. u32((game:GetService('Players').LocalPlayer.Character.Head.Position - v72.Handle.Position).Magnitude / 3) .. ' Distance'
                end
...
function UpdateIslandESP()
    local v75, v76, v77 = pairs(game:GetService('Workspace')._WorldOrigin.Locations:GetChildren())
    ...
    while true do
        ...
        pcall(function()
            if IslandESP then
                if u78.Name ~= 'Sea' then
                    if u78:FindFirstChild('NameEsp') then
                        u78.NameEsp.TextLabel.Text = u78.Name .. '   \n' .. u32((game:GetService('Players').LocalPlayer.Character.Head.Position - u78.Position).Magnitude / 3) .. ' Distance'
                    else
                        local _BillboardGui9 = Instance.new('BillboardGui', u78)

                        _BillboardGui9.Name = 'NameEsp'
                        _BillboardGui9.ExtentsOffset = Vector3.new(0, 1, 0)
                        _BillboardGui9.Size = UDim2.new(1, 200, 1, 30)
                        _BillboardGui9.Adornee = u78
            ...
            elseif u78:FindFirstChild('NameEsp') then
                u78:FindFirstChild('NameEsp'):Destroy()
            end
        end)
    end
end
...
local function u83(p82)
    return math.floor(tonumber(p82) + 0.5)
end

Number = math.random(1, 1000000)

function UpdatePlayerChams()
    local v84, v85, v86 = pairs(game:GetService('Players'):GetChildren())
    ...
    while true do
        ...
        pcall(function()
            if not isnil(u87.Character) then
                if ESPPlayer then
                    if isnil(u87.Character.Head) or u87.Character.Head:FindFirstChild('NameEsp' .. Number) then
                        u87.Character.Head['NameEsp' .. Number].TextLabel.Text = u87.Name .. ' | ' .. u83((game:GetService('Players').LocalPlayer.Character.Head.Position - u87.Character.Head.Position).Magnitude / 3) .. ' Distance\nHealth : ' .. u83(u87.Character.Humanoid.Health * 100 / u87.Character.Humanoid.MaxHealth) .. '%'
                    else
                        local _BillboardGui10 = Instance.new('BillboardGui', u87.Character.Head)
                        ...
                        _BillboardGui10.Adornee = u87.Character.Head
                        ...
                        _TextLabel10.Text = u87.Name .. ' \n' .. u83((game:GetService('Players').LocalPlayer.Character.Head.Position - u87.Character.Head.Position).Magnitude / 3) .. ' Distance'
                        ...
                        if u87.Team ~= game.Players.LocalPlayer.Team then
                            _TextLabel10.TextColor3 = Color3.new(255, 0, 0)
                        else
                            _TextLabel10.TextColor3 = Color3.new(0, 255, 0)
                        end
                    end
                elseif u87.Character.Head:FindFirstChild('NameEsp' .. Number) then
                    u87.Character.Head:FindFirstChild('NameEsp' .. Number):Destroy()
                end
            end
        end)
    end
...
function UpdateChestChams()
    ...
    while true do
        ...
        pcall(function()
            if string.find(u93.Name, 'Chest') then
                if ChestESP then
                    if string.find(u93.Name, 'Chest') then
                        if u93:FindFirstChild('NameEsp' .. Number) then
                            u93['NameEsp' .. Number].TextLabel.Text = u93.Name .. '   \n' .. u83((game:GetService('Players').LocalPlayer.Character.Head.Position - u93.Position).Magnitude / 3) .. ' Distance'
                        else
                            local _BillboardGui11 = Instance.new('BillboardGui', u93)
...
function UpdateDevilChams()
    ...
    while true do
        ...
        pcall(function()
            if DevilFruitESP then
                if string.find(u99.Name, 'Fruit') then
                    if u99.Handle:FindFirstChild('NameEsp' .. Number) then
                        u99.Handle['NameEsp' .. Number].TextLabel.Text = u99.Name .. '   \n' .. u83((game:GetService('Players').LocalPlayer.Character.Head.Position - u99.Handle.Position).Magnitude / 3) .. ' Distance'
                    else
                        local _BillboardGui12 = Instance.new('BillboardGui', u99.Handle)
                        ...
                        _BillboardGui12.Adornee = u99.Handle
                        ...
                        _TextLabel12.Text = u99.Name .. ' \n' .. u83((game:GetService('Players').LocalPlayer.Character.Head.Position - u99.Handle.Position).Magnitude / 3) .. ' Distance'
                    end
                end
            elseif u99.Handle:FindFirstChild('NameEsp' .. Number) then
                u99.Handle:FindFirstChild('NameEsp' .. Number):Destroy()
            end
        end)
    end
end
function UpdateFlowerChams()
    local v102, v103, v104 = pairs(game.Workspace:GetChildren())
    ...
    while true do
        ...
        pcall(function()
            if u105.Name == 'Flower2' or u105.Name == 'Flower1' then
                if FlowerESP then
                    if u105:FindFirstChild('NameEsp' .. Number) then
                        u105['NameEsp' .. Number].TextLabel.Text = u105.Name .. '   \n' .. u83((game:GetService('Players').LocalPlayer.Character.Head.Position - u105.Position).Magnitude / 3) .. ' Distance'
                    else
                        local _BillboardGui13 = Instance.new('BillboardGui', u105)
                        ...
                        if u105.Name == 'Flower1' then
                            _TextLabel13.Text = 'Blue Flower' .. ' \n' .. u83((game:GetService('Players').LocalPlayer.Character.Head.Position - u105.Position).Magnitude / 3) .. ' Distance'
                            _TextLabel13.TextColor3 = Color3.fromRGB(0, 0, 255)
                        end
                        if u105.Name == 'Flower2' then
                            _TextLabel13.Text = 'Red Flower' .. ' \n' .. u83((game:GetService('Players').LocalPlayer.Character.Head.Position - u105.Position).Magnitude / 3) .. ' Distance'
                            _TextLabel13.TextColor3 = Color3.fromRGB(255, 0, 0)
                        end
                    end
                elseif u105:FindFirstChild('NameEsp' .. Number) then
                    u105:FindFirstChild('NameEsp' .. Number):Destroy()
                end
            end
        end)
    end
...
function UpdateRealFruitChams()
    local v108, v109, v110 = pairs(game.Workspace.AppleSpawner:GetChildren())
        ...
        if v111:IsA('Tool') then
            if RealFruitESP then
                if v111.Handle:FindFirstChild('NameEsp' .. Number) then
                    v111.Handle['NameEsp' .. Number].TextLabel.Text = v111.Name .. ' ' .. u83((game:GetService('Players').LocalPlayer.Character.Head.Position - v111.Handle.Position).Magnitude / 3) .. ' Distance'
                else
                    local _BillboardGui14 = Instance.new('BillboardGui', v111.Handle)
                    ...
                    _BillboardGui14.Adornee = v111.Handle
                    ...
                    _TextLabel14.Text = v111.Name .. ' \n' .. u83((game:GetService('Players').LocalPlayer.Character.Head.Position - v111.Handle.Position).Magnitude / 3) .. ' Distance'
                end
    ...
    local v114, v115, v116 = pairs(game.Workspace.PineappleSpawner:GetChildren())
    ...
    while true do
        ...
        if v117:IsA('Tool') then
            if RealFruitESP then
                if v117.Handle:FindFirstChild('NameEsp' .. Number) then
                    v117.Handle['NameEsp' .. Number].TextLabel.Text = v117.Name .. ' ' .. u83((game:GetService('Players').LocalPlayer.Character.Head.Position - v117.Handle.Position).Magnitude / 3) .. ' Distance'
                else
                    local _BillboardGui15 = Instance.new('BillboardGui', v117.Handle)
                    ...
                    _BillboardGui15.Adornee = v117.Handle
                    ...
                    _TextLabel15.Text = v117.Name .. ' \n' .. u83((game:GetService('Players').LocalPlayer.Character.Head.Position - v117.Handle.Position).Magnitude / 3) .. ' Distance'
                end
            elseif v117.Handle:FindFirstChild('NameEsp' .. Number) then
                v117.Handle:FindFirstChild('NameEsp' .. Number):Destroy()
            end
        end
    end

    local v120, v121, v122 = pairs(game.Workspace.BananaSpawner:GetChildren())
    ...
    while true do
        ...
        if v123:IsA('Tool') then
            if RealFruitESP then
                if v123.Handle:FindFirstChild('NameEsp' .. Number) then
                    v123.Handle['NameEsp' .. Number].TextLabel.Text = v123.Name .. ' ' .. u83((game:GetService('Players').LocalPlayer.Character.Head.Position - v123.Handle.Position).Magnitude / 3) .. ' Distance'
                else
                    local _BillboardGui16 = Instance.new('BillboardGui', v123.Handle)
                    ...
                    _BillboardGui16.Adornee = v123.Handle
                    ...
                    _TextLabel16.Text = v123.Name .. ' \n' .. u83((game:GetService('Players').LocalPlayer.Character.Head.Position - v123.Handle.Position).Magnitude / 3) .. ' Distance'
                end
            elseif v123.Handle:FindFirstChild('NameEsp' .. Number) then
                v123.Handle:FindFirstChild('NameEsp' .. Number):Destroy()
            end
        end
    end
end
...
spawn(function()
    while wait() do
        pcall(function()
            if MobESP then
                local v126, v127, v128 = pairs(game:GetService('Workspace').Enemies:GetChildren())
                ...
                while true do
                    ...
                    if v129:FindFirstChild('HumanoidRootPart') then
                        if not v129:FindFirstChild('MobEap') then
                            local _BillboardGui17 = Instance.new('BillboardGui')
                            local _TextLabel17 = Instance.new('TextLabel')

                            _BillboardGui17.Parent = v129
                        ...
                        local v132 = math.floor((game.Players.LocalPlayer.Character.HumanoidRootPart.Position - v129.HumanoidRootPart.Position).Magnitude)

                        v129.MobEap.TextLabel.Text = v129.Name .. '-' .. v132 .. ' Distance'
                    end
                end
            else
                local v133, v134, v135 = pairs(game:GetService('Workspace').Enemies:GetChildren())
                ...
                while true do
                    ...
                    if v136:FindFirstChild('MobEap') then
                        v136.MobEap:Destroy()
                    end
                end
            end
...
spawn(function()
    while wait() do
        pcall(function()
            if SeaESP then
                local v137, v138, v139 = pairs(game:GetService('Workspace').SeaBeasts:GetChildren())
                ...
                while true do
                    ...
                    if v140:FindFirstChild('HumanoidRootPart') then
                        if not v140:FindFirstChild('Seaesps') then
                            local _BillboardGui18 = Instance.new('BillboardGui')
                            local _TextLabel18 = Instance.new('TextLabel')

                            _BillboardGui18.Parent = v140
                        ...
                        local v143 = math.floor((game.Players.LocalPlayer.Character.HumanoidRootPart.Position - v140.HumanoidRootPart.Position).Magnitude)

                        v140.Seaesps.TextLabel.Text = v140.Name .. '-' .. v143 .. ' Distance'
                    end
                end
            else
                local v144, v145, v146 = pairs(game:GetService('Workspace').SeaBeasts:GetChildren())
                ...
                while true do
                    ...
                    if v147:FindFirstChild('Seaesps') then
                        v147.Seaesps:Destroy()
                    end
                end
            end
        end)
...
spawn(function()
    while wait() do
        pcall(function()
            if NpcESP then
                local v148, v149, v150 = pairs(game:GetService('Workspace').NPCs:GetChildren())
                ...
                while true do
                    ...
                    if v151:FindFirstChild('HumanoidRootPart') then
                        ...
                        local v154 = math.floor((game.Players.LocalPlayer.Character.HumanoidRootPart.Position - v151.HumanoidRootPart.Position).Magnitude)

                        v151.NpcEspes.TextLabel.Text = v151.Name .. '-' .. v154 .. ' Distance'
                    end
                end
            else
                ...
                while true do
                    ...
                    if v158:FindFirstChild('NpcEspes') then
                        v158.NpcEspes:Destroy()
                    end
                end
            end
        end)
...
local function u161(p160)
    return math.floor(tonumber(p160) + 0.5)
end

Number = math.random(1, 1000000)

function UpdateIslandMirageESP()
    local v162, v163, v164 = pairs(game:GetService('Workspace')._WorldOrigin.Locations:GetChildren())

    while true do
        local u165

        v164, u165 = v162(v163, v164)
        ...
        pcall(function()
            if MirageIslandESP then
                if u165.Name == 'Mirage Island' then
                    if u165:FindFirstChild('NameEsp') then
                        u165.NameEsp.TextLabel.Text = u165.Name .. '   \n' .. u161((game:GetService('Players').LocalPlayer.Character.Head.Position - u165.Position).Magnitude / 3) .. ' M'
                    else
                        local _BillboardGui20 = Instance.new('BillboardGui', u165)

                        _BillboardGui20.Name = 'NameEsp'
                        _BillboardGui20.ExtentsOffset = Vector3.new(0, 1, 0)
                        _BillboardGui20.Size = UDim2.new(1, 200, 1, 30)
                        _BillboardGui20.Adornee = u165
            ...
            elseif u165:FindFirstChild('NameEsp') then
                u165:FindFirstChild('NameEsp'):Destroy()
            end
        end)
    end
end
function UpdateAuraESP()
    local v168, v169, v170 = pairs(game:GetService('Workspace').NPCs:GetChildren())
    ...
    while true do
        ...
        pcall(function()
            if AuraESP then
                if u171.Name == 'Master of Enhancement' then
                    if u171:FindFirstChild('NameEsp') then
                        u171.NameEsp.TextLabel.Text = u171.Name .. '   \n' .. u161((game:GetService('Players').LocalPlayer.Character.Head.Position - u171.Position).Magnitude / 3) .. ' M'
                    else
                        local _BillboardGui21 = Instance.new('BillboardGui', u171)

                        _BillboardGui21.Name = 'NameEsp'
                        _BillboardGui21.ExtentsOffset = Vector3.new(0, 1, 0)
                        _BillboardGui21.Size = UDim2.new(1, 200, 1, 30)
                        _BillboardGui21.Adornee = u171
            ...
            elseif u171:FindFirstChild('NameEsp') then
                u171:FindFirstChild('NameEsp'):Destroy()
            end
        end)
    end
end
function UpdateLSDESP()
    local v174, v175, v176 = pairs(game:GetService('Workspace').NPCs:GetChildren())

    while true do
        local u177

        v176, u177 = v174(v175, v176)
        ...
        pcall(function()
            if LADESP then
                if u177.Name == 'Legendary Sword Dealer' then
                    if u177:FindFirstChild('NameEsp') then
                        u177.NameEsp.TextLabel.Text = u177.Name .. '   \n' .. u161((game:GetService('Players').LocalPlayer.Character.Head.Position - u177.Position).Magnitude / 3) .. ' M'
                    else
                        local _BillboardGui22 = Instance.new('BillboardGui', u177)

                        _BillboardGui22.Name = 'NameEsp'
                        _BillboardGui22.ExtentsOffset = Vector3.new(0, 1, 0)
                        _BillboardGui22.Size = UDim2.new(1, 200, 1, 30)
                        _BillboardGui22.Adornee = u177
            ...
            elseif u177:FindFirstChild('NameEsp') then
                u177:FindFirstChild('NameEsp'):Destroy()
            end
        end)
    end
end
function UpdateGeaESP()
    local v180, v181, v182 = pairs(game:GetService('Workspace').Map.MysticIsland:GetChildren())
    ...
    while true do
        ...
        pcall(function()
            if GearESP then
                if u183.Name == 'MeshPart' then
                    if u183:FindFirstChild('NameEsp') then
                        u183.NameEsp.TextLabel.Text = u183.Name .. '   \n' .. u161((game:GetService('Players').LocalPlayer.Character.Head.Position - u183.Position).Magnitude / 3) .. ' M'
                    else
                        local _BillboardGui23 = Instance.new('BillboardGui', u183)

                        _BillboardGui23.Name = 'NameEsp'
                        _BillboardGui23.ExtentsOffset = Vector3.new(0, 1, 0)
                        _BillboardGui23.Size = UDim2.new(1, 200, 1, 30)
                        _BillboardGui23.Adornee = u183
...
function Tween2(p186)
    local _Magnitude = (p186.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude
    local v188 = 350
    local v189 = TweenInfo.new(_Magnitude / v188, Enum.EasingStyle.Linear)
    local v190 = game:GetService('TweenService'):Create(game.Players.LocalPlayer.Character.HumanoidRootPart, v189, {CFrame = p186})
    ...
    wait(_Magnitude / v188)

    _G.Clip2 = false
end
function BKP(p191)
    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = p191
...
function Tween(p192)
    local _Magnitude2 = (p192.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude
    local v194 = TweenSpeed
    local v195 = TweenInfo.new(_Magnitude2 / v194, Enum.EasingStyle.Linear)
    local v196 = game:GetService('TweenService'):Create(game.Players.LocalPlayer.Character.HumanoidRootPart, v195, {CFrame = p192})
...
function EquipTool(p197)
    if game.Players.LocalPlayer.Backpack:FindFirstChild(p197) then
        local v198 = game.Players.LocalPlayer.Backpack:FindFirstChild(p197)

        wait()
        game.Players.LocalPlayer.Character.Humanoid:EquipTool(v198)
    end
end
    ...
    pcall(function()
        game:GetService('RunService').Stepped:Connect(function()
            if _G.AutoEvoRace or (_G.Auto_RainbowHaki or (_G.Auto_SkullGuitar or (_G.CastleRaid or (_G.CollectAzure or (_G.TweenToKitsune or (_G.Auto_Sea3 or (_G.Auto_Sea2 or (_G.GhostShip or (_G.Ship or (_G.Auto_Holy_Torch or (_G.TeleportPly or (_G.Tweenfruit or (_G.Auto_Saber or (_G.Auto_PoleV1 or (_G.Auto_MusketeerHat or (_G.AutoFishCrew or (_G.AutoShark or (AutoFarmRace or (_G.AutoQuestRace or (_G.Auto_Warden or (Auto_Law or (_G.Auto_DualKatana or (Auto_Quest_Tushita_1 or (Auto_Quest_Tushita_2 or (Auto_Quest_Tushita_3 or (AutoTushita or (_G.AutoHolyTorch or (_G.Auto_Buddy or (_G.AutoTerrorshark or (_G.farmpiranya or (Auto_Quest_Yama_3 or (_G.Auto_ObservationV2 or (Auto_Quest_Yama_2 or (Auto_Quest_Yama_1 or (_G.AutoNear or (_G.Ectoplasm or (AutoEvoRace or (_G.AutoKillTrial or (AutoBartilo or (AutoFarmMasGun or (_G.Auto_Regoku or (_G.AutoLevel or (_G.Clip2 or (_G.AutoBone or (_G.Auto_Canvander or (_G.AutoBoneNoQuest or (_G.AutoBoss or (_G.Auto_Saw or (AutoFarmMasDevilFruit or (AutoHallowSycthe or (AutoTushita or (_G.Cake or (_G.AutoFarmSwan or (_G.AutoEliteor or (AutoNextIsland or (Musketeer or (_G.AutoMaterial or (_G.Factory or (_G.AutoFrozenDimension or (AutoFarmRaceQuest or (_G.AutoUpgrade or _G.TweenToFrozenDimension))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))) then
                local v200, v201, v202 = pairs(game:GetService('Players').LocalPlayer.Character:GetDescendants())
...
function CheckMaterial(p204)
    local v205, v206, v207 = pairs(game:GetService('ReplicatedStorage').Remotes.CommF_:InvokeServer('getInventory'))
    ...
    while true do
        ...
        if type(v208) == 'table' and (v208.Type == 'Material' and v208.Name == p204) then
            return v208.Count
        end
    end
...
function AttackNoCoolDown()
    ...
    local v216, v217, v218 = ipairs(_Character:GetChildren())
    local v219 = nil

    while true do
        local u220

        v218, u220 = v216(v217, v218)
        ...
        if u220:IsA('Tool') then
            break
        end
    end

    if u220 then
        local function u223(p221)
            local v222 = p221 and p221:FindFirstChild('Humanoid')

            if v222 then
                v222 = p221.Humanoid.Health > 0
            end

            return v222
        end
        local function v233(p224)
            local v225 = game:GetService('Workspace').Enemies:GetChildren()
            local _Position = _Character:GetPivot().Position
            local v227, v228, v229 = ipairs(v225)
            local v230 = {}

            while true do
                local v231

                v229, v231 = v227(v228, v229)

                if v229 == nil then
                    break
                end

                local _HumanoidRootPart = v231:FindFirstChild('HumanoidRootPart')

                if _HumanoidRootPart and (u223(v231) and (_HumanoidRootPart.Position - _Position).Magnitude <= p224) then
                    table.insert(v230, v231)
                end
            end
        ...
        if u220:FindFirstChild('LeftClickRemote') then
            local v234 = v233(60)
            local v235, v236, v237 = ipairs(v234)
            local u238 = 1
            ...
            while true do
                ...
                local _Unit = (v239.HumanoidRootPart.Position - _Character:GetPivot().Position).Unit

                pcall(function()
                    u220.LeftClickRemote:FireServer(_Unit, u238)
                end)

                local v241 = u238 + 1

                u238 = v241 > 1000000000 and 1 or v241
            end
        else
            local v242 = game:GetService('Workspace').Enemies:GetChildren()
            local _Position2 = _Character:GetPivot().Position
            local v244, v245, v246 = ipairs(v242)
            local v247 = u223
            local u248 = {}
            local u249 = nil

            while true do
                local v250, v251 = v244(v245, v246)
                ...
                if not v251:GetAttribute('IsBoat') and v247(v251) then
                    local _Head = v251:FindFirstChild('Head')

                    if _Head and (_Position2 - _Head.Position).Magnitude <= 60 then
                        table.insert(u248, {v251, _Head})
            ...
            pcall(function()
                ...
                if #u248 <= 0 then
                    ...
                    _RERegisterAttack:FireServer(0.5)
                    _RERegisterHit:FireServer(u249, u248)
                end
            end)
        end
    end
...
function to(p256)
    repeat
        ...
        game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = p256

        task.wait()

        game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = p256
    until (p256.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 2000
end
function to(p257)
    pcall(function()
        if (p257.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude >= 2000 and (not Auto_Raid and game.Players.LocalPlayer.Character.Humanoid.Health > 0) then
                            ...
                            if NameMon ~= 'ShipQuest2' then
                                if NameMon ~= 'FrostQuest' then
                                    repeat
                                        ...
                                        game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = p257

                                        wait(0.05)
                                        game.Players.LocalPlayer.Character.Head:Destroy()

                                        game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = p257
                                    until (p257.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude < 2500 and game.Players.LocalPlayer.Character.Humanoid.Health > 0
...
local _DropdownSelectWeapon = u19.Main:AddDropdown('DropdownSelectWeapon', {
...
_DropdownSelectWeapon:OnChanged(function(p259)
    ChooseWeapon = p259
end)
task.spawn(function()
    while wait() do
            ...
            if ChooseWeapon ~= 'Melee' then
                if ChooseWeapon ~= 'Sword' then
                    if ChooseWeapon == 'Blox Fruit' then
                        local v260, v261, v262 = pairs(game.Players.LocalPlayer.Backpack:GetChildren())
                        ...
                        while true do
                            ...
                            if v263.ToolTip == 'Blox Fruit' and game.Players.LocalPlayer.Backpack:FindFirstChild(tostring(v263.Name)) then
                                SelectWeapon = v263.Name
                            end
                        end
                    end
                else
                    local v264, v265, v266 = pairs(game.Players.LocalPlayer.Backpack:GetChildren())
                    ...
                    while true do
                        ...
                        if v267.ToolTip == 'Sword' and game.Players.LocalPlayer.Backpack:FindFirstChild(tostring(v267.Name)) then
                            SelectWeapon = v267.Name
                        end
                    end
                end
            else
                local v268, v269, v270 = pairs(game.Players.LocalPlayer.Backpack:GetChildren())
                ...
                while true do
                    ...
                    if v271.ToolTip == 'Melee' and game.Players.LocalPlayer.Backpack:FindFirstChild(tostring(v271.Name)) then
                        SelectWeapon = v271.Name
                    end
                end
            end
        end)
...
u19.Main:AddToggle('ToggleLevel', {
    Title = 'Farm Level',
    Description = 'Update 2650',
    Default = false,
                ...
                if string.find(game:GetService('Players').LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, NameMon) and game:GetService('Players').LocalPlayer.PlayerGui.Main.Quest.Visible ~= false then
                    if string.find(game:GetService('Players').LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, NameMon) or game:GetService('Players').LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                        ...
                        while true do
                            ...
                            if v276:FindFirstChild('Humanoid') and (v276:FindFirstChild('HumanoidRootPart') and (v276.Humanoid.Health > 0 and v276.Name == Ms)) then
                                repeat
                                    wait(_G.Fast_Delay)
                                    AttackNoCoolDown()
                                    ...
                                    Tween(v276.HumanoidRootPart.CFrame * Pos)

                                    v276.HumanoidRootPart.Size = Vector3.new(60, 60, 60)
                                    v276.HumanoidRootPart.Transparency = 1
                                    v276.Humanoid.JumpPower = 0
                                    v276.Humanoid.WalkSpeed = 0
                                    v276.HumanoidRootPart.CanCollide = false
                                    FarmPos = v276.HumanoidRootPart.CFrame
                                    MonFarm = v276.Name
                                until not _G.AutoLevel or (not v276.Parent or v276.Humanoid.Health <= 0) or (not game:GetService('Workspace').Enemies:FindFirstChild(v276.Name) or game.Players.LocalPlayer.PlayerGui.Main.Quest.Visible == false)

                                bringmob = false
                            end
                        end

                        local v277, v278, v279 = pairs(game:GetService('Workspace')._WorldOrigin.EnemySpawns:GetChildren())
                        ...
                        while true do
                            ...
                            if string.find(v280.Name, NameMon) and (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - v280.Position).Magnitude >= 10 then
...
u19.Main:AddToggle('ToggleMobAura', {
...
spawn(function()
    while wait() do
        if _G.AutoNear then
            pcall(function()
                local v282, v283, v284 = pairs(game.Workspace.Enemies:GetChildren())
                ...
                while true do
                    ...
                    if v285:FindFirstChild('Humanoid') and (v285:FindFirstChild('HumanoidRootPart') and (v285.Humanoid.Health > 0 and (v285.Name and (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - v285:FindFirstChild('HumanoidRootPart').Position).Magnitude <= 5000))) then
                        repeat
                            wait(_G.Fast_Delay)
                            AttackNoCoolDown()
                            ...
                            AutoHaki()
                            EquipTool(SelectWeapon)
                            Tween(v285.HumanoidRootPart.CFrame * Pos)

                            v285.HumanoidRootPart.Size = Vector3.new(60, 60, 60)
                            v285.HumanoidRootPart.Transparency = 1
                            v285.Humanoid.JumpPower = 0
                            v285.Humanoid.WalkSpeed = 0
                            v285.HumanoidRootPart.CanCollide = false
                            FarmPos = v285.HumanoidRootPart.CFrame
                            MonFarm = v285.Name
                        until not _G.AutoNear or (not v285.Parent or v285.Humanoid.Health <= 0) or not game.Workspace.Enemies:FindFirstChild(v285.Name)
...
u19.Main:AddToggle('ToggleCastleRaid', {
...
spawn(function()
    while wait() do
        if _G.CastleRaid then
            pcall(function()
                local v287 = CFrame.new(-5496.17432, 313.768921, -2841.53027, 0.924894512, 7.37058015e-9, 0.380223751, 3.5881019e-8, 1, -1.06665446e-7, -0.380223751, 1.12297109e-7, 0.924894512)
                ...
                if (CFrame.new(-5539.3115234375, 313.800537109375, -2972.372314453125).Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude > 500 then
                    ...
                    while true do
                        ...
                        if _G.CastleRaid and (v291:FindFirstChild('HumanoidRootPart') and (v291:FindFirstChild('Humanoid') and (v291.Humanoid.Health > 0 and (v291.HumanoidRootPart.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude < 2000))) then
                            repeat
                                wait(_G.Fast_Delay)
                                AttackNoCoolDown()
                                AutoHaki()
                            ...
                            until v291.Humanoid.Health <= 0 or not (v291.Parent and _G.CastleRaid)
                        end
                    end
                end
            end)
...
local function u296(p293, p294)
    ...
    game:GetService('ReplicatedStorage').Modules.Net:FindFirstChild('RF/FruitCustomizerRF'):InvokeServer(unpack(v295))
    Tween2(p294)
end
local function u300(p297, p298)
    local _Character2 = game.Players.LocalPlayer.Character

    if _Character2 and _Character2:FindFirstChild('HumanoidRootPart') then
        return (_Character2.HumanoidRootPart.Position - p297).Magnitude < p298
    else
        return false
    end
end
...
spawn(function()
    while true do
        if _G.EnableHakiFortress then
            u296('Snow White', Vector3.new(-4971.71826171875, 335.9582214355469, -3720.0595703125))

            while not u300(Vector3.new(-4971.71826171875, 335.9582214355469, -3720.0595703125), 1) do
                wait(0.1)
            end

            wait(0.5)
            u296('Pure Red', Vector3.new(-5414.92041015625, 314.2582092285156, -2212.20166015625))

            while not u300(Vector3.new(-5414.92041015625, 314.2582092285156, -2212.20166015625), 1) do
                wait(0.1)
            end

            wait(0.5)
            u296('Winter Sky', Vector3.new(-5420.26318359375, 1089.3582763671875, -2666.8193359375))

            while not u300(Vector3.new(-5420.26318359375, 1089.3582763671875, -2666.8193359375), 1) do
                wait(0.1)
            end
...
u19.Main:AddToggle('ToggleCollectChest', {
    Title = 'Nh\u{1eb7}t R\u{1b0}\u{1a1}ng',
    Description = '',
    Default = false,
}):OnChanged(function(p301)
    _G.AutoCollectChest = p301
end)
spawn(function()
    while wait() do
        if _G.AutoCollectChest then
            ...
            for v307 = 1, #__ChestTagged do
                local v308 = __ChestTagged[v307]
                local _Magnitude3 = (v308:GetPivot().Position - _Position3).Magnitude

                if not v308:GetAttribute('IsDisabled') then
            ...
            if v306 then
                local _Position4 = v306:GetPivot().Position
                local v311 = CFrame.new(_Position4)
...
spawn(function()
    while wait() do
        if _G.AutoCollectBerry then
            ...
            for v319 = 1, #_BerryBush do
                local v320 = _BerryBush[v319]
                ...
                while true do
                    ...
                    local _Magnitude4 = (v320.Parent:GetPivot().Position - _Position5).Magnitude
            ...
            if v317 then
                local _Position6 = v317.Parent:GetPivot().Position
                local v327 = CFrame.new(_Position6)

                Tween2(v327)
                u17:Notify({
                    Title = 'P\u{1ecb}a',
                    Content = 'T\u{ec}m Th\u{1ea5}y Berry: ' .. tostring(v318),
                    Duration = 10,
                })
            else
                Hop()
...
u19.Main:AddSection('Th\u{f4}ng Th\u{1ea1}o')

local _DropdownMastery = u19.Main:AddDropdown('DropdownMastery', {
...
_DropdownMastery:OnChanged(function(p329)
    TypeMastery = p329
end)
u19.Main:AddToggle('ToggleMasteryFruit', {
    Title = 'Farm Tr\u{e1}i',
    Description = '',
    Default = false,
}):OnChanged(function(p330)
    AutoFarmMasDevilFruit = p330
end)
_Options.ToggleMasteryFruit:SetValue(false)
u19.Main:AddToggle('ToggleMasteryGun', {
    Title = 'Farm S\u{fa}ng',
    Description = '',
    Default = false,
...
local _SliderHealt = u19.Main:AddSlider('SliderHealt', {
...
_SliderHealt:OnChanged(function(p334)
    KillPercent = p334
end)
...
spawn(function()
    while wait() do
        if AutoFarmMasDevilFruit and TypeMastery == 'Near Mob' then
            pcall(function()
                local v340, v341, v342 = pairs(game.Workspace.Enemies:GetChildren())
                ...
                while true do
                    ...
                    if v343.Name and (v343:FindFirstChild('Humanoid') and (v343:FindFirstChild('HumanoidRootPart') and (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - v343:FindFirstChild('HumanoidRootPart').Position).Magnitude <= 5000)) then
                        repeat
                            if true then
                                wait(_G.Fast_Delay)
                        ...
                        until not AutoFarmMasDevilFruit or (not MasteryType == 'Near Mob' or (not v343.Parent or (v343.Humanoid.Health == 0 or not TypeMastery == 'Near Mob')))
...
spawn(function()
    ...
    pcall(function()
        local v344 = CFrame.new(904.4072265625, 181.05767822266, 33341.38671875)
    ...
    if true then
        ...
        if v348.Humanoid.Health > v348.Humanoid.MaxHealth * KillPercent / 100 then
            _G.UseSkill = false
            ...
            v348.HumanoidRootPart.Size = Vector3.new(60, 60, 60)
    ...
    if AutoFarmMasDevilFruit and (not MasteryType ~= 'Ecto' and (v348.Parent and (v348.Humanoid.Health ~= 0 and not TypeMastery ~= 'Ecto'))) then
    else
    end
    ...
    local v349, v350, v351 = pairs(game:GetService('ReplicatedStorage'):GetChildren())
    ...
    while true do
        ...
        if v352.Name ~= 'Ship Steward' then
            if v352.Name ~= 'Ship Engineer' then
                if v352.Name ~= 'Ship Deckhand' then
                    if v352.Name == 'Ship Officer' then
    ...
    if v348:FindFirstChild('Humanoid') and (v348:FindFirstChild('HumanoidRootPart') and (v348.Name == 'Ship Steward' or (v348.Name == 'Ship Engineer' or (v348.Name == 'Ship Deckhand' or v348.Name == 'Ship Officer')))) then
    else
    end
end)
spawn(function()
    ...
    pcall(function()
        local v353 = CFrame.new(-9508.5673828125, 142.1398468017578, 5737.3603515625)
    ...
    if true then
        ...
        if v357.Humanoid.Health > v357.Humanoid.MaxHealth * KillPercent / 100 then
            _G.UseSkill = false
    ...
    if AutoFarmMasDevilFruit and (not MasteryType ~= 'Cake' and (v357.Parent and (v357.Humanoid.Health ~= 0 and not TypeMastery ~= 'Cake'))) then
    else
    end
    ...
    local v358, v359, v360 = pairs(game:GetService('ReplicatedStorage'):GetChildren())
    ...
    while true do
        ...
        if v361.Name ~= 'Cookie Crafter' then
            if v361.Name ~= 'Cake Guard' then
                if v361.Name ~= 'Baking Staff' then
                    if v361.Name == 'Head Baker' then
                        Tween(v361.HumanoidRootPart.CFrame * Pos)
                    end
                else
                    Tween(v361.HumanoidRootPart.CFrame * Pos)
                end
    ...
    if v357:FindFirstChild('Humanoid') and (v357:FindFirstChild('HumanoidRootPart') and (v357.Name == 'Cookie Crafter' or (v357.Name == 'Cake Guard' or (v357.Name == 'Baking Staff' or v357.Name == 'Head Baker')))) then
    else
    end
end)
spawn(function()
    ...
    local v362, v363, v364 = pairs(game.Workspace.Enemies:GetChildren())

    if true then
        wait(_G.Fast_Delay)

        if v365.Humanoid.Health > v365.Humanoid.MaxHealth * KillPercent / 100 then
            _G.UseSkill = false
            ...
            v365.HumanoidRootPart.Transparency = 1
            v365.Humanoid.JumpPower = 0
            v365.Humanoid.WalkSpeed = 0
            v365.HumanoidRootPart.CanCollide = false
            FarmPos = v365.HumanoidRootPart.CFrame
            MonFarm = v365.Name
    ...
    if AutoFarmMasDevilFruit and (not MasteryType ~= 'Level No Quest' and (v365.Parent and (v365.Humanoid.Health ~= 0 and not TypeMastery ~= 'Level No Quest'))) then
    else
    end
    ...
    if v365:FindFirstChild('Humanoid') and (v365:FindFirstChild('HumanoidRootPart') and v365.Name == Ms) then
    else
    end
end)
spawn(function()
    ...
    if AutoFarmMasDevilFruit and (not MasteryType ~= 'Level' and (v369.Parent and (v369.Humanoid.Health ~= 0 and not TypeMastery ~= 'Level'))) then
    end
    ...
    if v369:FindFirstChild('Humanoid') and (v369:FindFirstChild('HumanoidRootPart') and v369.Name == Ms) then
    else
    end
end)
spawn(function()
    ...
    pcall(function()
        local v370 = CFrame.new(-9508.5673828125, 142.1398468017578, 5737.3603515625)

        Tween(v370)
    end)

    local v371, v372, v373 = pairs(game.Workspace.Enemies:GetChildren())

    if true then
        wait(_G.Fast_Delay)

        if v374.Humanoid.Health > v374.Humanoid.MaxHealth * KillPercent / 100 then
            _G.UseSkill = false
            ...
            v374.HumanoidRootPart.Transparency = 1
            v374.Humanoid.JumpPower = 0
            v374.Humanoid.WalkSpeed = 0
            v374.HumanoidRootPart.CanCollide = false
            FarmPos = v374.HumanoidRootPart.CFrame
            MonFarm = v374.Name
    ...
    if AutoFarmMasDevilFruit and (not MasteryType ~= 'Bone' and (v374.Parent and (v374.Humanoid.Health ~= 0 and not TypeMastery ~= 'Bone'))) then
    else
    end
    ...
    local v375, v376, v377 = pairs(game:GetService('ReplicatedStorage'):GetChildren())
    ...
    while true do
        ...
        if v378.Name ~= 'Reborn Skeleton' then
            if v378.Name ~= 'Living Zombie' then
                if v378.Name ~= 'Demonic Soul' then
                    if v378.Name == 'Posessed Mummy' then
                        Tween(v378.HumanoidRootPart.CFrame * Pos)
                    end
                else
                    Tween(v378.HumanoidRootPart.CFrame * Pos)
                end
    ...
    if v374:FindFirstChild('Humanoid') and (v374:FindFirstChild('HumanoidRootPart') and (v374.Name == 'Reborn Skeleton' or (v374.Name == 'Living Zombie' or (v374.Name == 'Demonic Soul' or v374.Name == 'Posessed Mummy')))) then
    else
    end
end)
spawn(function()
    while task.wait() do
        if _G.UseSkillGun then
            pcall(function()
                ...
                local v379, v380, v381 = pairs(game:GetService('Workspace').Enemies:GetChildren())
                local v382
                ...
                if v382.Name ~= MonFarm or (not v382:FindFirstChild('Humanoid') or (not v382:FindFirstChild('HumanoidRootPart') or v382.Humanoid.Health > v382.Humanoid.MaxHealth * KillPercent / 100)) then
                else
                end

                game:GetService('RunService').Heartbeat:wait()
                EquipToolGun()
                Tween(v382.HumanoidRootPart.CFrame * Pos)

                PositionSkillMasteryGun = v382.HumanoidRootPart.Position
                ...
                if AutoFarmMasGun and (_G.UseSkillGun and v382.Humanoid.Health ~= 0) then
                else
                end
            end)
        end
        ...
        if AutoFarmMasGun and TypeMastery == 'Near Mob' then
            pcall(function()
                ...
                while true do
                    ...
                    if v386.Name and (v386:FindFirstChild('Humanoid') and (v386:FindFirstChild('HumanoidRootPart') and (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - v386:FindFirstChild('HumanoidRootPart').Position).Magnitude <= 5000)) then
                        repeat
                            if true then
                                wait(_G.Fast_Delay)
                        ...
                        until not AutoFarmMasGun or (not MasteryType == 'Near Mob' or (not v386.Parent or (v386.Humanoid.Health == 0 or not TypeMastery == 'Near Mob')))
...
spawn(function()
    ...
    pcall(function()
        local v387 = CFrame.new(904.4072265625, 181.05767822266, 33341.38671875)
    ...
    if true then
        ...
        if v391.Humanoid.Health > v391.Humanoid.MaxHealth * KillPercent / 100 then
            _G.UseSkillGun = false
            ...
            v391.HumanoidRootPart.Size = Vector3.new(60, 60, 60)
            v391.HumanoidRootPart.Transparency = 1
    ...
    if AutoFarmMasGun and (not MasteryType ~= 'Ecto' and (v391.Parent and (v391.Humanoid.Health ~= 0 and not TypeMastery ~= 'Ecto'))) then
    else
    end
    ...
    local v392, v393, v394 = pairs(game:GetService('ReplicatedStorage'):GetChildren())
    ...
    while true do
        ...
        if v395.Name ~= 'Ship Steward' then
            if v395.Name ~= 'Ship Engineer' then
                if v395.Name ~= 'Ship Deckhand' then
                    if v395.Name == 'Ship Officer' then
    ...
    if v391:FindFirstChild('Humanoid') and (v391:FindFirstChild('HumanoidRootPart') and (v391.Name == 'Ship Steward' or (v391.Name == 'Ship Engineer' or (v391.Name == 'Ship Deckhand' or v391.Name == 'Ship Officer')))) then
    else
    end
end)
spawn(function()
    ...
    pcall(function()
        local v396 = CFrame.new(-1579.9111328125, 329.7358703613281, -12310.365234375)

        Tween(v396)
    end)

    local v397, v398, v399 = pairs(game.Workspace.Enemies:GetChildren())

    if true then
        wait(_G.Fast_Delay)

        if v400.Humanoid.Health > v400.Humanoid.MaxHealth * KillPercent / 100 then
            _G.UseSkillGun = false
            ...
            EquipTool(SelectWeapon)
            Tween(v400.HumanoidRootPart.CFrame * Pos)

            v400.HumanoidRootPart.Size = Vector3.new(60, 60, 60)
            v400.HumanoidRootPart.Transparency = 1
            v400.Humanoid.JumpPower = 0
            v400.Humanoid.WalkSpeed = 0
            v400.HumanoidRootPart.CanCollide = false
            FarmPos = v400.HumanoidRootPart.CFrame
            MonFarm = v400.Name
    ...
    if AutoFarmMasGun and (not MasteryType ~= 'Cake' and (v400.Parent and (v400.Humanoid.Health ~= 0 and not TypeMastery ~= 'Cake'))) then
    else
    end
    ...
    local v401, v402, v403 = pairs(game:GetService('ReplicatedStorage'):GetChildren())
    ...
    while true do
        ...
        if v404.Name ~= 'Cookie Crafter' then
            if v404.Name ~= 'Cake Guard' then
                if v404.Name ~= 'Baking Staff' then
                    if v404.Name == 'Head Baker' then
                        Tween(v404.HumanoidRootPart.CFrame * Pos)
                    end
                else
                    Tween(v404.HumanoidRootPart.CFrame * Pos)
                end
    ...
    if v400:FindFirstChild('Humanoid') and (v400:FindFirstChild('HumanoidRootPart') and (v400.Name == 'Cookie Crafter' or (v400.Name == 'Cake Guard' or (v400.Name == 'Baking Staff' or v400.Name == 'Head Baker')))) then
    else
    end
end)
spawn(function()
    ...
    local v405, v406, v407 = pairs(game:GetService('Workspace').Enemies:GetChildren())

    if true then
        wait(_G.Fast_Delay)

        if v408.Humanoid.Health > v408.Humanoid.MaxHealth * KillPercent / 100 then
            _G.UseSkillGun = false
            ...
            EquipTool(SelectWeapon)
            Tween(v408.HumanoidRootPart.CFrame * Pos)

            v408.HumanoidRootPart.Size = Vector3.new(60, 60, 60)
            v408.HumanoidRootPart.Transparency = 1
            v408.Humanoid.JumpPower = 0
            v408.Humanoid.WalkSpeed = 0
            v408.HumanoidRootPart.CanCollide = false
            FarmPos = v408.HumanoidRootPart.CFrame
            MonFarm = v408.Name
    ...
    if AutoFarmMasGun and (not MasteryType ~= 'Level' and (v408.Parent and (v408.Humanoid.Health ~= 0 and not TypeMastery ~= 'Level'))) then
    end
    ...
    if v408:FindFirstChild('Humanoid') and (v408:FindFirstChild('HumanoidRootPart') and v408.Name == Ms) then
    else
    end
end)
spawn(function()
    ...
    if AutoFarmMasGun and (not MasteryType ~= 'Level No Quest' and (v412.Parent and (v412.Humanoid.Health ~= 0 and not TypeMastery ~= 'Level No Quest'))) then
    else
    end
    ...
    if v412:FindFirstChild('Humanoid') and (v412:FindFirstChild('HumanoidRootPart') and v412.Name == Ms) then
    else
    end
end)
spawn(function()
    ...
    pcall(function()
        local v413 = CFrame.new(-9508.5673828125, 142.1398468017578, 5737.3603515625)

        Tween(v413)
    end)

    local v414, v415, v416 = pairs(game.Workspace.Enemies:GetChildren())

    if true then
        wait(_G.Fast_Delay)

        if v417.Humanoid.Health > v417.Humanoid.MaxHealth * KillPercent / 100 then
            _G.UseSkillGun = false
            ...
            EquipTool(SelectWeapon)
            Tween(v417.HumanoidRootPart.CFrame * Pos)
            ...
            FarmPos = v417.HumanoidRootPart.CFrame
            MonFarm = v417.Name
    ...
    if AutoFarmMasGun and (not MasteryType ~= 'Bone' and (v417.Parent and (v417.Humanoid.Health ~= 0 and not TypeMastery ~= 'Bone'))) then
    else
    end
    ...
    local v418, v419, v420 = pairs(game:GetService('ReplicatedStorage'):GetChildren())
    ...
    while true do
        ...
        if v421.Name ~= 'Reborn Skeleton' then
            if v421.Name ~= 'Living Zombie' then
                if v421.Name ~= 'Demonic Soul' then
                    if v421.Name == 'Posessed Mummy' then
                        Tween(v421.HumanoidRootPart.CFrame * Pos)
                    end
                else
                    Tween(v421.HumanoidRootPart.CFrame * Pos)
                end
    ...
    if v417:FindFirstChild('Humanoid') and (v417:FindFirstChild('HumanoidRootPart') and (v417.Name == 'Reborn Skeleton' or (v417.Name == 'Living Zombie' or (v417.Name == 'Demonic Soul' or v417.Name == 'Posessed Mummy')))) then
    else
    end
end)
...
function EquipToolGun()
    pcall(function()
        local v422, v423, v424 = pairs(game.Players.LocalPlayer.Backpack:GetChildren())
        ...
        while true do
            ...
            if v425.ToolTip == 'Gun' and v425:IsA('Tool') then
                local v426 = game.Players.LocalPlayer.Backpack:FindFirstChild(v425.Name)

                game.Players.LocalPlayer.Character.Humanoid:EquipTool(v426)
            end
        end
    end)
end
...
spawn(function()
    local v427 = getrawmetatable(game)
    local ___namecall = v427.__namecall

    setreadonly(v427, false)

    v427.__namecall = newcclosure(function(...)
        local v429 = getnamecallmethod()
        local v430 = {...}

        if tostring(v429) == 'FireServer' and (tostring(v430[1]) == 'RemoteEvent' and (tostring(v430[2]) ~= 'true' and tostring(v430[2]) ~= 'false')) then
            if _G.UseSkillGun then
                if type(v430[2]) ~= 'vector' then
                    v430[2] = CFrame.new(PositionSkillMasteryGun)
                else
                    v430[2] = PositionSkillMasteryGun
                end

                return ___namecall(unpack(v430))
            end
            if _G.UseSkill then
                if type(v430[2]) ~= 'vector' then
                    v430[2] = CFrame.new(PositionSkillMasteryDevilFruit)
                else
                    v430[2] = PositionSkillMasteryDevilFruit
                end
...
if Sea3 then
    u19.Main:AddSection('X\u{1b0}\u{1a1}ng')

    local u431 = u19.Main:AddParagraph({
    ...
    spawn(function()
        pcall(function()
            while wait() do
                ...
                u431:SetDesc('M\u{e0}y C\u{f3}: ' .. tostring(_Bones) .. ' X\u{1b0}\u{1a1}ng')
            end
        end)
    end)
    u19.Main:AddToggle('ToggleBone', {
        Title = 'Farm X\u{1b0}\u{1a1}ng',
        Description = '',
        Default = false,
    }):OnChanged(function(p433)
        _G.AutoBone = p433
    ...
    local u434 = CFrame.new(-9515.75, 174.8521728515625, 6079.40625)
            ...
            if _G.AutoBone then
                pcall(function()
                    ...
                    if game:GetService('Players').LocalPlayer.PlayerGui.Main.Quest.Visible == false then
                        ...
                        if (u434.Position - game:GetService('Players').LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 3 then
                        ...
                        while true do
                            ...
                            if v439:FindFirstChild('HumanoidRootPart') and (v439:FindFirstChild('Humanoid') and (v439.Humanoid.Health > 0 and (v439.Name == 'Reborn Skeleton' or (v439.Name == 'Living Zombie' or (v439.Name == 'Demonic Soul' or v439.Name == 'Posessed Mummy'))))) then
                                if string.find(game:GetService('Players').LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, 'Demonic Soul') then
                                    ...
                                    if _G.AutoBone and (v439.Humanoid.Health > 0 and v439.Parent) and game:GetService('Players').LocalPlayer.PlayerGui.Main.Quest.Visible ~= false then
                                    end
                                else
                                    game:GetService('ReplicatedStorage').Remotes.CommF_:InvokeServer('AbandonQuest')
    ...
    local u440 = CFrame.new(-9515.75, 174.8521728515625, 6079.40625)
        ...
        while wait() do
            if _G.AutoBoneNoQuest then
                pcall(function()
                    ...
                    local _ = (u440.Position - game:GetService('Players').LocalPlayer.Character.HumanoidRootPart.Position).Magnitude > 3
                    ...
                    if game:GetService('Workspace').Enemies:FindFirstChild('Reborn Skeleton') or (game:GetService('Workspace').Enemies:FindFirstChild('Living Zombie') or (game:GetService('Workspace').Enemies:FindFirstChild('Demonic Soul') or game:GetService('Workspace').Enemies:FindFirstChild('Posessed Mummy'))) then
                        ...
                        while true do
                            ...
                            if v444:FindFirstChild('HumanoidRootPart') and (v444:FindFirstChild('Humanoid') and (v444.Humanoid.Health > 0 and (v444.Name == 'Reborn Skeleton' or (v444.Name == 'Living Zombie' or (v444.Name == 'Demonic Soul' or v444.Name == 'Posessed Mummy'))))) then
                                repeat
                                    wait(_G.Fast_Delay)
                                    AttackNoCoolDown()
                                    AutoHaki()
                                    ...
                                    v444.HumanoidRootPart.Transparency = 1
                                    ...
                                    MonFarm = v444.Name
                                until not _G.AutoBoneNoQuest or (v444.Humanoid.Health <= 0 or not v444.Parent)
                            end
                        end
                    end
                end)
    ...
    u19.Main:AddToggle('ToggleRandomBone', {
        Title = 'Random X\u{1b0}\u{1a1}ng',
        Description = '',
        Default = false,
    }):OnChanged(function(p445)
        _G.AutoRandomBone = p445
    end)
...
if Sea3 then
    u19.Main:AddSection('T\u{1b0} L\u{1ec7}nh B\u{e1}nh')

    local u446 = u19.Main:AddParagraph({
                ...
                if string.len(game:GetService('ReplicatedStorage').Remotes.CommF_:InvokeServer('CakePrinceSpawner')) ~= 88 then
                    if string.len(game:GetService('ReplicatedStorage').Remotes.CommF_:InvokeServer('CakePrinceSpawner')) ~= 87 then
                        if string.len(game:GetService('ReplicatedStorage').Remotes.CommF_:InvokeServer('CakePrinceSpawner')) ~= 86 then
                            u446:SetDesc('T\u{1b0} L\u{1ec7}nh B\u{e1}nh : \u{2705}\u{fe0f}')
                        else
                            u446:SetDesc('C\u{f2}n: ' .. string.sub(game:GetService('ReplicatedStorage').Remotes.CommF_:InvokeServer('CakePrinceSpawner'), 39, 39) .. ' ')
                        end
                    else
                        u446:SetDesc('C\u{f2}n: ' .. string.sub(game:GetService('ReplicatedStorage').Remotes.CommF_:InvokeServer('CakePrinceSpawner'), 39, 40) .. '')
                    end
                else
                    u446:SetDesc('C\u{f2}n: ' .. string.sub(game:GetService('ReplicatedStorage').Remotes.CommF_:InvokeServer('CakePrinceSpawner'), 39, 41) .. '')
                end
            end)
        end
    end)
    u19.Main:AddToggle('ToggleCake', {
        Title = 'Farm T\u{1b0} L\u{1ec7}nh B\u{e1}nh',
        Description = '',
        Default = false,
                ...
                pcall(function()
                    if game.ReplicatedStorage:FindFirstChild('Cake Prince') or (game:GetService('Workspace').Enemies:FindFirstChild('Cake Prince') or (game.ReplicatedStorage:FindFirstChild('Dough King') or game:GetService('Workspace').Enemies:FindFirstChild('Dough King'))) then
                        if game:GetService('Workspace').Enemies:FindFirstChild('Cake Prince') or game:GetService('Workspace').Enemies:FindFirstChild('Dough King') then
                            local v448, v449, v450 = pairs(game:GetService('Workspace').Enemies:GetChildren())
                            ...
                            while true do
                                ...
                                if v451.Name == 'Cake Prince' or v451.Name == 'Dough King' then
                                    repeat
                                        wait(_G.Fast_Delay)
                                        AutoHaki()
                                        EquipTool(SelectWeapon)

                                        v451.HumanoidRootPart.CanCollide = false
                                        v451.Humanoid.WalkSpeed = 0
                                        v451.HumanoidRootPart.Size = Vector3.new(60, 60, 60)

                                        Tween(v451.HumanoidRootPart.CFrame * Pos)
                                        AttackNoCoolDown()
                                    until _G.Cake == false or (not v451.Parent or v451.Humanoid.Health <= 0)
                                end
                            end
                        else
                    ...
                    elseif game.Workspace.Enemies:FindFirstChild('Baking Staff') or (game.Workspace.Enemies:FindFirstChild('Head Baker') or (game.Workspace.Enemies:FindFirstChild('Cake Guard') or game.Workspace.Enemies:FindFirstChild('Cookie Crafter'))) then
                        ...
                        while true do
                            ...
                            if (v455.Name == 'Baking Staff' or (v455.Name == 'Head Baker' or (v455.Name == 'Cake Guard' or v455.Name == 'Cookie Crafter'))) and v455.Humanoid.Health > 0 then
                                repeat
                                    wait(_G.Fast_Delay)
                                    AutoHaki()
                                    EquipTool(SelectWeapon)
                                    ...
                                    POSCAKE = v455.HumanoidRootPart.CFrame

                                    Tween(v455.HumanoidRootPart.CFrame * Pos)
                                    AttackNoCoolDown()
                                until _G.Cake == false or (game:GetService('ReplicatedStorage'):FindFirstChild('Cake Prince') or (game:GetService('ReplicatedStorage'):FindFirstChild('Dough King') or (not v455.Parent or v455.Humanoid.Health <= 0)))
                            end
                        end
                    else
                        bringmob = false
        ...
        game:GetService('RunService').Heartbeat:Connect(function()
            pcall(function()
                ...
                while true do
                    ...
                    if _G.Cake and (bringmob and (v459.Name == 'Cookie Crafter' or (v459.Name == 'Cake Guard' or (v459.Name == 'Baking Staff' or v459.Name == 'Head Baker')))) and (v459.HumanoidRootPart.Position - POSCAKE.Position).magnitude <= 350 then
                        v459.HumanoidRootPart.CFrame = POSCAKE
                        v459.HumanoidRootPart.CanCollide = false
                        v459.HumanoidRootPart.Size = Vector3.new(60, 60, 60)

                        if v459.Humanoid:FindFirstChild('Animator') then
                            v459.Humanoid.Animator:Destroy()
                        end
                ...
                pcall(function()
                    if game.ReplicatedStorage:FindFirstChild('Cake Prince') or (game:GetService('Workspace').Enemies:FindFirstChild('Cake Prince') or (game.ReplicatedStorage:FindFirstChild('Dough King') or game:GetService('Workspace').Enemies:FindFirstChild('Dough King'))) then
                        if game:GetService('Workspace').Enemies:FindFirstChild('Cake Prince') or game:GetService('Workspace').Enemies:FindFirstChild('Dough King') then
                            ...
                            while true do
                                ...
                                if v463.Name == 'Cake Prince' or v463.Name == 'Dough King' then
                                    repeat
                                        wait(_G.Fast_Delay)
                                        AutoHaki()
                                        EquipTool(SelectWeapon)

                                        v463.HumanoidRootPart.CanCollide = false
                                        v463.Humanoid.WalkSpeed = 0
                                        v463.HumanoidRootPart.Size = Vector3.new(60, 60, 60)

                                        Tween(v463.HumanoidRootPart.CFrame * Pos)
                                        AttackNoCoolDown()
                                    until _G.Cake == false or (not v463.Parent or v463.Humanoid.Health <= 0)
                                end
                            end
                        else
                            Tween(CFrame.new(-2009.2802734375, 4532.97216796875, -14937.3076171875))
                    ...
                    elseif game.Workspace.Enemies:FindFirstChild('Baking Staff') or (game.Workspace.Enemies:FindFirstChild('Head Baker') or (game.Workspace.Enemies:FindFirstChild('Cake Guard') or game.Workspace.Enemies:FindFirstChild('Cookie Crafter'))) then
                        ...
                        while true do
                            ...
                            if (v467.Name == 'Baking Staff' or (v467.Name == 'Head Baker' or (v467.Name == 'Cake Guard' or v467.Name == 'Cookie Crafter'))) and v467.Humanoid.Health > 0 then
                                repeat
                                    wait(_G.Fast_Delay)
                                    AutoHaki()
                                    EquipTool(SelectWeapon)
                                    ...
                                    bringmob = true
                                    v467.HumanoidRootPart.Size = Vector3.new(60, 60, 60)
                                    POSCAKE = v467.HumanoidRootPart.CFrame

                                    Tween(v467.HumanoidRootPart.CFrame * Pos)
                                    AttackNoCoolDown()
                                until _G.Cake == false or (game:GetService('ReplicatedStorage'):FindFirstChild('Cake Prince') or (game:GetService('ReplicatedStorage'):FindFirstChild('Dough King') or (not v467.Parent or v467.Humanoid.Health <= 0)))
                            end
                        end
                    else
                        bringmob = false
...
if Sea2 then
    u19.Main:AddSection('Ectoplasm Farm')
    u19.Main:AddToggle('ToggleVatChatKiDi', {
            ...
            pcall(function()
                if _G.Ectoplasm then
                    if game:GetService('Workspace').Enemies:FindFirstChild('Ship Deckhand') or (game:GetService('Workspace').Enemies:FindFirstChild('Ship Engineer') or (game:GetService('Workspace').Enemies:FindFirstChild('Ship Steward') or game:GetService('Workspace').Enemies:FindFirstChild('Ship Officer'))) then
                        local v470, v471, v472 = pairs(game:GetService('Workspace').Enemies:GetChildren())
                        ...
                        while true do
                            ...
                            if (v473.Name == 'Ship Steward' or (v473.Name == 'Ship Engineer' or (v473.Name == 'Ship Deckhand' or v473.Name == 'Ship Officer' and v473:FindFirstChild('Humanoid')))) and v473.Humanoid.Health > 0 then
                                repeat
                                    wait(_G.Fast_Delay)
                                    AttackNoCoolDown()
                                    AutoHaki()
                                    ...
                                    v473.HumanoidRootPart.Size = Vector3.new(60, 60, 60)
                                    v473.HumanoidRootPart.Transparency = 1
                                    v473.Humanoid.JumpPower = 0
                                    v473.Humanoid.WalkSpeed = 0
                                    v473.HumanoidRootPart.CanCollide = false
                                    FarmPos = v473.HumanoidRootPart.CFrame
                                    MonFarm = v473.Name
                                until _G.Ectoplasm == false or (not v473.Parent or v473.Humanoid.Health == 0) or not game:GetService('Workspace').Enemies:FindFirstChild(v473.Name)
...
local _DropdownBoss = u19.Main:AddDropdown('DropdownBoss', {
...
_DropdownBoss:OnChanged(function(p475)
    _G.SelectBoss = p475
end)
u19.Main:AddToggle('ToggleAutoFarmBoss', {
    Title = '\u{fffd}\u{e1}nh Tr\u{f9}m',
    Description = '',
    Default = false,
}):OnChanged(function(p476)
    _G.AutoBoss = p476
end)
            ...
            pcall(function()
                if game:GetService('Workspace').Enemies:FindFirstChild(_G.SelectBoss) then
                    ...
                    while true do
                        ...
                        if v480.Name == _G.SelectBoss and (v480:FindFirstChild('Humanoid') and (v480:FindFirstChild('HumanoidRootPart') and v480.Humanoid.Health > 0)) then
                            repeat
                                wait(_G.Fast_Delay)
                                AttackNoCoolDown()
                                AutoHaki()
                                ...
                                v480.HumanoidRootPart.Size = Vector3.new(60, 60, 60)

                                Tween(v480.HumanoidRootPart.CFrame * Pos)
                                sethiddenproperty(game:GetService('Players').LocalPlayer, 'SimulationRadius', math.huge)
                            until not _G.AutoBoss or (not v480.Parent or v480.Humanoid.Health <= 0)
                        end
                    end
...
u19.Main:AddSection('Nguy\u{ea}n Li\u{1ec7}u')
...
local _DropdownMaterial = u19.Main:AddDropdown('DropdownMaterial', {
...
_DropdownMaterial:OnChanged(function(p482)
    SelectMaterial = p482
end)
u19.Main:AddToggle('ToggleMaterial', {
    Title = 'Farm Nguy\u{ea}n Li\u{1ec7}u',
    Description = '',
    Default = false,
}):OnChanged(function(p483)
    _G.AutoMaterial = p483
            ...
            pcall(function()
                ...
                if game:GetService('Workspace').Enemies:FindFirstChild(MMon) then
                    ...
                    while true do
                        ...
                        if v487:FindFirstChild('Humanoid') and (v487:FindFirstChild('HumanoidRootPart') and (v487.Humanoid.Health > 0 and v487.Name == MMon)) then
                            repeat
                                wait(_G.Fast_Delay)
                                AttackNoCoolDown()
                                AutoHaki()
                                ...
                                EquipTool(SelectWeapon)
                                Tween(v487.HumanoidRootPart.CFrame * Pos)

                                v487.HumanoidRootPart.Size = Vector3.new(60, 60, 60)
                                v487.HumanoidRootPart.Transparency = 1
                                v487.Humanoid.JumpPower = 0
                                v487.Humanoid.WalkSpeed = 0
                                v487.HumanoidRootPart.CanCollide = false
                                FarmPos = v487.HumanoidRootPart.CFrame
                                MonFarm = v487.Name
                            until not _G.AutoMaterial or (not v487.Parent or v487.Humanoid.Health <= 0)

                            bringmob = false
                        end
                    end
                else
                    local v488, v489, v490 = pairs(game:GetService('Workspace')._WorldOrigin.EnemySpawns:GetChildren())
                    ...
                    while true do
                        ...
                        if string.find(v491.Name, Mon) and (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - v491.Position).Magnitude >= 10 then
                            Tween(v491.HumanoidRootPart.CFrame * Pos)
                        end
                    end
                end
            end)
...
if Sea3 then
    u19.Sea:AddSection('\u{fffd}\u{1ea3}o C\u{e1}o')

    local u492 = u19.Sea:AddParagraph({
    ...
    function UpdateKitsune()
        if game.Workspace._WorldOrigin.Locations:FindFirstChild('Kitsune Island') then
            u492:SetDesc('\u{fffd}\u{1ea3}o C\u{e1}o : \u{2705}\u{fe0f}')
        else
            u492:SetDesc('\u{fffd}\u{1ea3}o C\u{e1}o : \u{274c}\u{fe0f}')
        end
    end
    ...
    spawn(function()
        ...
        while not v494 do
            v494 = game:GetService('Workspace').Map:FindFirstChild('KitsuneIsland')

            wait(1)
        end
        while wait() do
            if _G.TweenToKitsune then
                local _ShrineActive = v494:FindFirstChild('ShrineActive')

                if _ShrineActive then
                    local v496, v497, v498 = pairs(_ShrineActive:GetDescendants())
                    ...
                    while true do
                        ...
                        if v499:IsA('BasePart') and v499.Name:find('NeonShrinePart') then
                            Tween2(v499.CFrame)
                        end
                    end
                end
    ...
    u19.Sea:AddToggle('ToggleCollectAzure', {
        Title = 'Nh\u{1eb7}t Linh H\u{1ed3}n',
        Description = '',
        Default = false,
    }):OnChanged(function(p500)
        _G.CollectAzure = p500
    end)
    ...
    u19.Sea:AddSection('Bi\u{1ec3}n')
    ...
    local u506 = _LocalPlayer4.Character or _LocalPlayer4.CharacterAdded:Wait()
    local u507 = 350
    local u508 = 3000
    local u509 = Vector3.new(-16665.191, 104.596, 1579.694)
    local u510 = {
        80,
        -50,
        -80,
    ...
    local function u518()
        local v512, v513, v514 = pairs(_Workspace.Boats:GetChildren())
        ...
        while true do
            ...
            local _VehicleSeat = v515:FindFirstChild('VehicleSeat')

            if _VehicleSeat then
                local v517 = u506

                if _VehicleSeat.Occupant == v517:FindFirstChild('Humanoid') then
                    return v515
                end
            end
        end
    ...
    _RunService.RenderStepped:Connect(function()
        if u506 and u506.PrimaryPart then
            local _Magnitude5 = (u506.PrimaryPart.Position - u509).Magnitude

            if u508 <= math.floor(_Magnitude5 / 10) then
                local v520 = u518()

                if v520 and v520.PrimaryPart then
                    local v521 = u510[u511]

                    v520:SetPrimaryPartCFrame(v520.PrimaryPart.CFrame * CFrame.Angles(0, math.rad(v521), 0))
    ...
    local function v560(p526, p527, p528, p529, p530)
        local v531 = u19.Sea:AddToggle(p527, {
            Title = p526,
            Default = false,
        })

        _Options[p527]:SetValue(false)
        v531:OnChanged(function(p532)
            _G[p527] = p532
        end)
        _RunService.RenderStepped:Connect(function()
            if _G[p527] then
                local _Humanoid = u506:FindFirstChild('Humanoid')
                ...
                if _Humanoid then
                    local function v538()
                        ...
                        local v534, v535, v536 = pairs(u522)
                    ...
                    local v539, v540, v541 = pairs(_Workspace.Boats:GetChildren())
                    local v542 = false
                    local v543 = nil
                    ...
                    while true do
                        ...
                        v541, v544 = v539(v540, v541)

                        if v541 == nil then
                            break
                        end

                        local _VehicleSeat2 = v544:FindFirstChild('VehicleSeat')
                    ...
                    if v542 then
                        v543.MaxSpeed = u507
                        v543.CFrame = CFrame.new(v543.Position) * v543.CFrame.Rotation

                        _VirtualInputManager2:SendKeyEvent(true, 'W', false, game)

                        local v546, v547, v548 = pairs(_Workspace.Boats:GetDescendants())
                        ...
                        local v550 = u506
                        local v551, v552, v553 = pairs(v550:GetDescendants())
                        ...
                        local v555, v556, v557 = ipairs(p528)
                        ...
                        while true do
                            ...
                            local v559 = _Workspace.Map:FindFirstChild(v558)
                        ...
                        if _Workspace.Map:FindFirstChild(p529) then
                            _VirtualInputManager2:SendKeyEvent(false, 'W', false, game)
    ...
    v560('T\u{ec}m \u{110}\u{1ea3}o Dung Nham', 'AutoFindPrehistoric', v525.Prehistoric, 'PrehistoricIsland', '\u{fffd}\u{1ea3}o Dung Nham T\u{ec}m Th\u{1ea5}y')
    v560('T\u{ec}m \u{110}\u{1ea3}o B\u{ed} \u{1ea8}n', 'AutoFindMirage', v525.Mirage, 'MysticIsland', '\u{fffd}\u{1ea3}o B\u{ed} \u{1ea8}n T\u{ec}m Th\u{1ea5}y')
    v560('T\u{ec}m \u{110}\u{1ea3}o Leviathan', 'AutoFindFrozen', v525.Frozen, 'FrozenDimension', '\u{fffd}\u{1ea3}o Leviathan T\u{ec}m Th\u{1ea5}y')
    u19.Sea:AddToggle('AutoComeTiki', {
        Title = 'L\u{e1}i Thuy\u{1ec1}n V\u{1ec1} \u{110}\u{1ea3}o Tiki',
        Description = '',
        Default = false,
    }):OnChanged(function(p561)
        _G.AutoComeTiki = p561
    end)
    _RunService.RenderStepped:Connect(function()
        ...
        local v564, v565, v566 = pairs(_Workspace.Boats:GetChildren())
        local v567 = nil
        ...
        while true do
            ...
            local _VehicleSeat3 = v568:FindFirstChild('VehicleSeat')
        ...
        if _VehicleSeat3 then
            _VehicleSeat3.MaxSpeed = u507

            local v570 = CFrame.new(-16217.7568359375, 9.126761436462402, 446.06536865234375)
            local _Position7 = _VehicleSeat3.Position
            local _Position8 = v570.Position
            local v573 = (_Position8 - _Position7).unit * _VehicleSeat3.MaxSpeed * _RunService.RenderStepped:Wait()

            _VehicleSeat3.CFrame = _VehicleSeat3.CFrame + v573
    ...
    _RunService.RenderStepped:Connect(function()
        ...
        local v577, v578, v579 = pairs(_Workspace.Boats:GetChildren())
        local v580 = nil
        ...
        while true do
            ...
            local _VehicleSeat4 = v581:FindFirstChild('VehicleSeat')
        ...
        if _VehicleSeat4 then
            _VehicleSeat4.MaxSpeed = u507

            local v583 = CFrame.new(5193.9375, -0.04690289497375488, 1631.578369140625)
            local _Position9 = _VehicleSeat4.Position
            local _Position10 = v583.Position
            local v586 = (_Position10 - _Position9).unit * _VehicleSeat4.MaxSpeed * _RunService.RenderStepped:Wait()

            _VehicleSeat4.CFrame = _VehicleSeat4.CFrame + v586
    ...
    local u587 = {}
    local _DropdownBoat = u19.Sea:AddDropdown('DropdownBoat', {
    ...
    _DropdownBoat:OnChanged(function(p589)
        selectedBoat = p589
    end)

    local function u596(p590)
        game:GetService('ReplicatedStorage').Remotes.CommF_:InvokeServer(unpack({
            'BuyBoat',
            p590,
        }))
        task.delay(2, function()
            local v591, v592, v593 = pairs(_Workspace.Boats:GetChildren())
            ...
            while true do
                ...
                if v594:IsA('Model') and v594.Name == p590 then
                    local _VehicleSeat5 = v594:FindFirstChild('VehicleSeat')

                    if _VehicleSeat5 and not _VehicleSeat5.Occupant then
                        u587[p590] = _VehicleSeat5
                    end
                end
            end
        end)
    ...
    local function u601()
        local v597, v598, v599 = pairs(u587)
    ...
    game:GetService('RunService').RenderStepped:Connect(function()
        local v602, v603, v604 = pairs(u587)
        ...
        while true do
            ...
            if v605 and (v605.Parent and (v605.Name == 'VehicleSeat' and not v605.Occupant)) then
                u587[v604] = v605
            end
        end
    end)
    ...
    u19.Sea:AddToggle('ToggleTerrorshark', {
        Title = '\u{fffd}\u{e1}nh C\u{e1} M\u{1ead}p',
        Description = '',
        Default = false,
    }):OnChanged(function(p606)
        _G.AutoTerrorshark = p606
    end)
                        ...
                        if not _G.IsFlying and _Character5.Humanoid.Health >= 8000 then
                            if game:GetService('Workspace').Enemies:FindFirstChild('Terrorshark') then
                                ...
                                while true do
                                    ...
                                    if v611.Name == 'Terrorshark' and (v611:FindFirstChild('Humanoid') and (v611:FindFirstChild('HumanoidRootPart') and v611.Humanoid.Health > 0)) then
                                        while true do
                                            wait(_G.Fast_Delay)
                                            ...
                                            if not _G.AutoTerrorshark or (not v611.Parent or (v611.Humanoid.Health <= 0 or _G.IsFlying)) then
                                                break
                                            end
                                        end
                                    end
    ...
    u19.Sea:AddToggle('TogglePiranha', {
                ...
                pcall(function()
                    if game:GetService('Workspace').Enemies:FindFirstChild('Piranha') then
                        ...
                        while true do
                            ...
                            if v616.Name == 'Piranha' and (v616:FindFirstChild('Humanoid') and (v616:FindFirstChild('HumanoidRootPart') and v616.Humanoid.Health > 0)) then
                                repeat
                                    wait(_G.Fast_Delay)
                                    AttackNoCoolDown()
                                    AutoHaki()
                                ...
                                until not _G.farmpiranya or (not v616.Parent or v616.Humanoid.Health <= 0)
                            end
                        end
                ...
                pcall(function()
                    if game:GetService('Workspace').Enemies:FindFirstChild('Shark') then
                        ...
                        while true do
                            ...
                            if v621.Name == 'Shark' and (v621:FindFirstChild('Humanoid') and (v621:FindFirstChild('HumanoidRootPart') and v621.Humanoid.Health > 0)) then
                                repeat
                                    wait(_G.Fast_Delay)
                                    AttackNoCoolDown()
                                    AutoHaki()
                                ...
                                until not _G.AutoShark or (not v621.Parent or v621.Humanoid.Health <= 0)
                            end
                        end
                    else
                ...
                pcall(function()
                    if game:GetService('Workspace').Enemies:FindFirstChild('Fish Crew Member') then
                        ...
                        while true do
                            ...
                            if v626.Name == 'Fish Crew Member' and (v626:FindFirstChild('Humanoid') and (v626:FindFirstChild('HumanoidRootPart') and v626.Humanoid.Health > 0)) then
                                repeat
                                    wait(_G.Fast_Delay)
                                    AttackNoCoolDown()
                                    AutoHaki()
                                    ...
                                    v626.HumanoidRootPart.Size = Vector3.new(60, 60, 60)

                                    Tween(v626.HumanoidRootPart.CFrame * Pos)

                                    game.Players.LocalPlayer.Character.Humanoid.Sit = false
                                until not _G.AutoFishCrew or (not v626.Parent or v626.Humanoid.Health <= 0)
                            end
                        end
                    else
                        Tween(game:GetService('Workspace').Boats.PirateGrandBrigade.VehicleSeat.CFrame * CFrame.new(0, 1, 0))
    ...
    function CheckPirateBoat()
        local v628 = next
        local v629, v630 = game:GetService('Workspace').Enemies:GetChildren()
        local v631 = {
            'PirateGrandBrigade',
            'PirateBrigade',
        }
        ...
        while true do
            ...
            if table.find(v631, v632.Name) and (v632:FindFirstChild('Health') and v632.Health.Value > 0) then
                return v632
            end
        end
    end
            ...
            if _G.Ship then
                pcall(function()
                    if CheckPirateBoat() then
                        ...
                        local v633 = CheckPirateBoat()

                        repeat
                            wait()
                            spawn(Tween(v633.Engine.CFrame * CFrame.new(0, -20, 0)), 1)

                            AimBotSkillPosition = game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame * CFrame.new(0, -5, 0)
                            Skillaimbot = true
                            AutoSkill = false
                        until not v633 or (not v633.Parent or (v633.Health.Value <= 0 or not CheckPirateBoat()))
    ...
    u19.Sea:AddToggle('ToggleGhostShip', {
    ...
    function CheckPirateBoat()
        local v635 = next
        local v636, v637 = game:GetService('Workspace').Enemies:GetChildren()
        local v638 = {
            'FishBoat',
        }
        ...
        while true do
            ...
            v637, v639 = v635(v636, v637)

            if v637 == nil then
                break
            end
            if table.find(v638, v639.Name) and (v639:FindFirstChild('Health') and v639.Health.Value > 0) then
                return v639
            end
        end
    end
        ...
        while wait() do
            pcall(function()
                if _G.bjirFishBoat and CheckPirateBoat() then
                    ...
                    local v640 = CheckPirateBoat()

                    repeat
                        wait()
                        spawn(Tween(v640.Engine.CFrame * CFrame.new(0, -20, 0), 1))

                        AutoSkill = true
                        Skillaimbot = true
                        AimBotSkillPosition = game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame * CFrame.new(0, -5, 0)
                    until v640.Parent or (v640.Health.Value <= 0 or not CheckPirateBoat())
            ...
            if _G.bjirFishBoat then
                pcall(function()
                    if CheckPirateBoat() then
                        ...
                        local v641, v642, v643 = pairs(game.Players.LocalPlayer.Backpack:GetChildren())
                        ...
                        while true do
                            ...
                            if v644:IsA('Tool') and v644.ToolTip == 'Melee' then
                                game.Players.LocalPlayer.Character.Humanoid:EquipTool(v644)
                            end
                        end
                        ...
                        local v645, v646, v647 = pairs(game.Players.LocalPlayer.Backpack:GetChildren())
                        ...
                        while true do
                            ...
                            if v648:IsA('Tool') and v648.ToolTip == 'Blox Fruit' then
                                game.Players.LocalPlayer.Character.Humanoid:EquipTool(v648)
                            end
                        end
                        ...
                        local v649, v650, v651 = pairs(game.Players.LocalPlayer.Backpack:GetChildren())
                        ...
                        while true do
                            ...
                            if v652:IsA('Tool') and v652.ToolTip == 'Sword' then
                                game.Players.LocalPlayer.Character.Humanoid:EquipTool(v652)
                            end
                        end
                        ...
                        local v653, v654, v655 = pairs(game.Players.LocalPlayer.Backpack:GetChildren())
                        ...
                        while true do
                            ...
                            if v656:IsA('Tool') and v656.ToolTip == 'Gun' then
                                game.Players.LocalPlayer.Character.Humanoid:EquipTool(v656)
                            end
                        end
    ...
    u19.Main:AddSection('Elite')

    local u657 = u19.Main:AddParagraph({
        ...
        while wait() do
            pcall(function()
                if game:GetService('ReplicatedStorage'):FindFirstChild('Diablo') or (game:GetService('ReplicatedStorage'):FindFirstChild('Deandre') or (game:GetService('ReplicatedStorage'):FindFirstChild('Urban') or (game:GetService('Workspace').Enemies:FindFirstChild('Diablo') or (game:GetService('Workspace').Enemies:FindFirstChild('Deandre') or game:GetService('Workspace').Enemies:FindFirstChild('Urban'))))) then
                    u657:SetDesc('Elite Boss: \u{2705}\u{fe0f} | Killed:  ' .. game:GetService('ReplicatedStorage').Remotes.CommF_:InvokeServer('EliteHunter', 'Progress'))
                else
                    u657:SetDesc('Elite Boss: \u{274c}\u{fe0f} | Killed: ' .. game:GetService('ReplicatedStorage').Remotes.CommF_:InvokeServer('EliteHunter', 'Progress'))
                end
            end)
        end
    end)
    u19.Main:AddToggle('ToggleElite', {
        Title = '\u{fffd}\u{e1}nh Elite',
        Description = '',
        Default = false,
    }):OnChanged(function(p658)
        _G.AutoElite = p658
    end)
                    ...
                    elseif string.find(game:GetService('Players').LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, 'Diablo') or (string.find(game:GetService('Players').LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, 'Deandre') or string.find(game:GetService('Players').LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, 'Urban')) then
                        if game:GetService('Workspace').Enemies:FindFirstChild('Diablo') or (game:GetService('Workspace').Enemies:FindFirstChild('Deandre') or game:GetService('Workspace').Enemies:FindFirstChild('Urban')) then
                            ...
                            while true do
                                ...
                                if v662:FindFirstChild('Humanoid') and (v662:FindFirstChild('HumanoidRootPart') and (v662.Humanoid.Health > 0 and (v662.Name == 'Diablo' or (v662.Name == 'Deandre' or v662.Name == 'Urban')))) then
                                    repeat
                                        wait(_G.Fast_Delay)
                                        AttackNoCoolDown()
                                        EquipTool(SelectWeapon)
                                        AutoHaki()
                                        Tween2(v662.HumanoidRootPart.CFrame * Pos)

                                        v662.Humanoid.WalkSpeed = 0
                                        v662.HumanoidRootPart.CanCollide = false
                                        v662.HumanoidRootPart.Size = Vector3.new(60, 60, 60)
                                    until _G.AutoElite == false or (v662.Humanoid.Health <= 0 or not v662.Parent)
                                end
                            end
...
if Sea3 then
    u19.Sea:AddSection('\u{fffd}\u{1ea3}o B\u{ed} \u{1ea8}n')

    local u663 = u19.Sea:AddParagraph({
    ...
    spawn(function()
        pcall(function()
            while wait() do
                u663:SetDesc('\u{fffd}\u{1ea3}o B\u{ed} \u{1ea8}n: ' .. MirageStatus .. ' | Tr\u{103}ng Tr\u{f2}n: ' .. FullMoonStatus)
            end
        end)
    end)
    u19.Sea:AddButton({
    ...
    function TweenToHighestPoint()
        local v665 = getHighestPoint()

        if v665 then
            Tween2(v665.CFrame * CFrame.new(0, 211.88, 0))
        end
    end
    function getHighestPoint()
        ...
        local v666, v667, v668 = pairs(game:GetService('Workspace').Map.MysticIsland:GetDescendants())
        ...
        while true do
            ...
            if v669:IsA('MeshPart') and v669.MeshId == 'rbxassetid://120225267909374' then
                return v669
            end
        end
    end
...
u19.Sea:AddToggle('ToggleTpAdvanced', {
    Title = 'Bay \u{110}\u{1ebf}n Advanced Fruit Dealer',
    Description = '',
    Default = false,
}):OnChanged(function(p670)
    _G.AutoTpAdvanced = p670
end)
spawn(function()
    while wait() do
...
u19.Sea:AddToggle('ToggleTweenGear', {
    ...
    pcall(function()
        while wait() do
            if _G.TweenToGear and game:GetService('Workspace').Map:FindFirstChild('MysticIsland') then
                local v674, v675, v676 = pairs(game:GetService('Workspace').Map.MysticIsland:GetChildren())
                ...
                while true do
                    ...
                    if v677:IsA('MeshPart') and v677.Material == Enum.Material.Neon then
                        Tween2(v677.CFrame)
                    end
                end
            end
    ...
    while wait() do
        pcall(function()
            if _G.AutoLockMoon then
                local v679 = game.Lighting:GetMoonDirection()
                local v680 = game.Workspace.CurrentCamera.CFrame.p + v679 * 100

                game.Workspace.CurrentCamera.CFrame = CFrame.lookAt(game.Workspace.CurrentCamera.CFrame.p, v680)
            end
        end)
    end
end)
...
u19.Item:AddToggle('ToggleAutoSaber', {
    Title = 'Saber',
    Description = '',
    Default = false,
                ...
                if game:GetService('Workspace').Map.Jungle.Final.Part.Transparency ~= 0 then
                    if game:GetService('Workspace').Enemies:FindFirstChild('Saber Expert') or game:GetService('ReplicatedStorage'):FindFirstChild('Saber Expert') then
                        ...
                        while true do
                            ...
                            if v685:FindFirstChild('Humanoid') and (v685:FindFirstChild('HumanoidRootPart') and (v685.Humanoid.Health > 0 and v685.Name == 'Saber Expert')) then
                                repeat
                                    task.wait(_G.Fast_Delay)
                                    EquipTool(SelectWeapon)
                                    Tween(v685.HumanoidRootPart.CFrame * Pos)

                                    v685.HumanoidRootPart.Size = Vector3.new(60, 60, 60)
                                    v685.HumanoidRootPart.Transparency = 1
                                    v685.Humanoid.JumpPower = 0
                                    v685.Humanoid.WalkSpeed = 0
                                    v685.HumanoidRootPart.CanCollide = false
                                    bringmob = true
                                    FarmPos = v685.HumanoidRootPart.CFrame
                                    MonFarm = v685.Name

                                    AttackNoCoolDown()
                                until v685.Humanoid.Health <= 0 or not _G.Auto_Saber

                                bringmob = true

                                if v685.Humanoid.Health <= 0 then
                            ...
                            if game:GetService('ReplicatedStorage').Remotes.CommF_:InvokeServer('ProQuestProgress', 'RichSon') ~= nil then
                                ...
                                elseif game:GetService('Workspace').Enemies:FindFirstChild('Mob Leader') or game:GetService('ReplicatedStorage'):FindFirstChild('Mob Leader') then
                                    ...
                                    while true do
                                        ...
                                        if v689.Name == 'Mob Leader' then
                                            if game:GetService('Workspace').Enemies:FindFirstChild('Mob Leader [Lv. 120] [Boss]') and (v689:FindFirstChild('Humanoid') and (v689:FindFirstChild('HumanoidRootPart') and v689.Humanoid.Health > 0)) then
                                                repeat
                                                    task.wait(_G.Fast_Delay)
                                                    AutoHaki()
                                                    EquipTool(SelectWeapon)
                                                    ...
                                                    v689.HumanoidRootPart.Size = Vector3.new(60, 60, 60)

                                                    Tween(v689.HumanoidRootPart.CFrame * Pos)
                                                    AttackNoCoolDown()
                                                until v689.Humanoid.Health <= 0 or not _G.Auto_Saber
                                            end
...
u19.Item:AddToggle('ToggleAutoPoleV1', {
    Title = 'Pole V1',
    Description = '',
    Default = false,
...
local u691 = CFrame.new(-7748.0185546875, 5606.80615234375, -2305.898681640625)
            ...
            pcall(function()
                if game:GetService('Workspace').Enemies:FindFirstChild('Thunder God') then
                    ...
                    while true do
                        ...
                        if v695.Name == 'Thunder God' and (v695:FindFirstChild('Humanoid') and (v695:FindFirstChild('HumanoidRootPart') and v695.Humanoid.Health > 0)) then
                            repeat
                                task.wait(_G.Fast_Delay)
                                AutoHaki()
                                EquipTool(SelectWeapon)
                                ...
                                v695.HumanoidRootPart.Size = Vector3.new(50, 50, 50)

                                Tween(v695.HumanoidRootPart.CFrame * Pos)
                                AttackNoCoolDown()
                            until not _G.Auto_PoleV1 or (not v695.Parent or v695.Humanoid.Health <= 0)
                        end
                    end
                elseif (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - u691.Position).Magnitude < 1500 then
                    Tween(u691)
                end
...
u19.Item:AddToggle('ToggleAutoSaw', {
    Title = 'C\u{1b0}a C\u{e1} M\u{1ead}p',
    Description = '',
    Default = false,
}):OnChanged(function(p696)
    _G.Auto_Saw = p696
end)
_Options.ToggleAutoSaw:SetValue(false)

local u697 = CFrame.new(-690.33081054688, 15.09425163269, 1582.2380371094)
            ...
            pcall(function()
                if game:GetService('Workspace').Enemies:FindFirstChild('The Saw') then
                    ...
                    while true do
                        ...
                        if v701.Name == 'The Saw' and (v701:FindFirstChild('Humanoid') and (v701:FindFirstChild('HumanoidRootPart') and v701.Humanoid.Health > 0)) then
                            repeat
                                task.wait(_G.Fast_Delay)
                                AutoHaki()
                                EquipTool(SelectWeapon)
                                ...
                                v701.HumanoidRootPart.Size = Vector3.new(50, 50, 50)

                                Tween(v701.HumanoidRootPart.CFrame * Pos)
                                AttackNoCoolDown()
                            until not _G.Auto_Saw or (not v701.Parent or v701.Humanoid.Health <= 0)
                        end
                    end
                elseif (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - u697.Position).Magnitude < 1500 then
                    Tween(u697)
                end
...
u19.Item:AddToggle('ToggleAutoWarden', {
    Title = 'Ki\u{1ebf}m Qu\u{1ea3}n Ng\u{1ee5}c',
    Description = '',
    Default = false,
}):OnChanged(function(p702)
    _G.Auto_Warden = p702
end)
_Options.ToggleAutoWarden:SetValue(false)

local u703 = CFrame.new(5186.14697265625, 24.86684226989746, 832.1885375976563)
            ...
            pcall(function()
                if game:GetService('Workspace').Enemies:FindFirstChild('Chief Warden') then
                    ...
                    while true do
                        ...
                        if v707.Name == 'Chief Warden' and (v707:FindFirstChild('Humanoid') and (v707:FindFirstChild('HumanoidRootPart') and v707.Humanoid.Health > 0)) then
                            repeat
                                task.wait(_G.Fast_Delay)
                                AutoHaki()
                                EquipTool(SelectWeapon)
                                ...
                                AttackNoCoolDown()
                            until not _G.Auto_Warden or (not v707.Parent or v707.Humanoid.Health <= 0)
                        end
                    end
                elseif (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - u703.Position).Magnitude < 1500 then
                    Tween(u703)
                end
...
if Sea3 then
                ...
                pcall(function()
                    if game:GetService('Workspace').Enemies:FindFirstChild('Soul Reaper') then
                        ...
                        while true do
                            ...
                            if string.find(v712.Name, 'Soul Reaper') then
                                repeat
                                    wait(_G.Fast_Delay)
                                    AttackNoCoolDown()
                                    AutoHaki()
                                    ...
                                    Tween(v712.HumanoidRootPart.CFrame * Pos)

                                    v712.HumanoidRootPart.Transparency = 1

                                    sethiddenproperty(game.Players.LocalPlayer, 'SimulationRadius', math.huge)
                                until v712.Humanoid.Health <= 0 or AutoHallowSycthe == false
                            end
                        end
    ...
    u19.Item:AddToggle('ToggleYama', {
        Title = 'Yama',
        Description = '',
        Default = false,
    }):OnChanged(function(p713)
        _G.AutoYama = p713
    end)
    ...
    u19.Item:AddToggle('ToggleTushita', {
        Title = 'Tushita',
        Description = '',
        Default = false,
    ...
    spawn(function()
        ...
        if v718.Name == ('Longma' or v718.Name == 'Longma') and (v718.Humanoid.Health > 0 and (v718:IsA('Model') and (v718:FindFirstChild('Humanoid') and v718:FindFirstChild('HumanoidRootPart')))) then
        else
        end
        ...
        v718.Humanoid:ChangeState(11)
        Tween(v718.HumanoidRootPart.CFrame * Pos)

        if AutoTushita and (v718.Parent and v718.Humanoid.Health > 0) then
        else
        end
    end)
    u19.Item:AddToggle('ToggleHoly', {
        Title = '\u{fffd}\u{1ed1}t \u{110}u\u{1ed1}c',
        Description = '',
        Default = false,
    }):OnChanged(function(p719)
        _G.Auto_Holy_Torch = p719
    end)
...
u19.Item:AddToggle('ToggleAutoCanvander', {
    Title = 'Canvander',
    Description = '',
    Default = false,
}):OnChanged(function(p720)
    _G.Auto_Canvander = p720
end)
_Options.ToggleAutoCanvander:SetValue(false)

local u721 = CFrame.new(5311.07421875, 426.0243835449219, 165.12762451171875)
            ...
            pcall(function()
                if game:GetService('Workspace').Enemies:FindFirstChild('Beautiful Pirate') then
                    ...
                    while true do
                        ...
                        if v725.Name == 'Beautiful Pirate' and (v725:FindFirstChild('Humanoid') and (v725:FindFirstChild('HumanoidRootPart') and v725.Humanoid.Health > 0)) then
                            repeat
                                task.wait(_G.Fast_Delay)
                                AutoHaki()
                                EquipTool(SelectWeapon)
                                ...
                                AttackNoCoolDown()
                            until not _G.Auto_Canvander or (not v725.Parent or v725.Humanoid.Health <= 0)
                        end
                    end
                elseif (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - u721.Position).Magnitude < 1500 then
                    Tween(u721)
                end
...
u19.Item:AddToggle('ToggleAutoMusketeerHat', {
    Title = 'M\u{169} L\u{ed}nh Ng\u{1ef1} L\u{e2}m',
    Description = '',
    Default = false,
}):OnChanged(function(p726)
    _G.Auto_MusketeerHat = p726
end)
                    ...
                    elseif game:GetService('Players').LocalPlayer.PlayerGui.Main.Quest.Visible and (string.find(game:GetService('Players').LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, 'Captain Elephant') and game:GetService('Players').LocalPlayer.PlayerGui.Main.Quest.Visible == true) then
                        if game:GetService('Workspace').Enemies:FindFirstChild('Captain Elephant') then
                            ...
                            while true do
                                ...
                                if u730.Name == 'Captain Elephant' then
                                    OldCFrameElephant = u730.HumanoidRootPart.CFrame
                                    ...
                                    repeat
                                        ...
                                        pcall(function()
                                            ...
                                            u730.HumanoidRootPart.CanCollide = false
                                            u730.HumanoidRootPart.Size = Vector3.new(50, 50, 50)

                                            Tween(u730.HumanoidRootPart.CFrame * Pos)

                                            u730.HumanoidRootPart.CanCollide = false
                                            u730.HumanoidRootPart.CFrame = OldCFrameElephant

                                            AttackNoCoolDown()
                                        end)
                                    until _G.Auto_MusketeerHat == false or (u730.Humanoid.Health <= 0 or not u730.Parent) or game:GetService('Players').LocalPlayer.PlayerGui.Main.Quest.Visible == false
                                end
                            end
                        else
                ...
                elseif string.find(game:GetService('Players').LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, 'Forest Pirate') and (string.find(game:GetService('Players').LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, '50') and game:GetService('Players').LocalPlayer.PlayerGui.Main.Quest.Visible == true) then
                    if game:GetService('Workspace').Enemies:FindFirstChild('Forest Pirate') then
                        ...
                        while true do
                            ...
                            if u734.Name == 'Forest Pirate' then
                                repeat
                                    task.wait(_G.Fast_Delay)
                                    pcall(function()
                                        EquipTool(SelectWeapon)
                                        ...
                                        u734.HumanoidRootPart.Size = Vector3.new(50, 50, 50)

                                        Tween(u734.HumanoidRootPart.CFrame * Pos)

                                        u734.HumanoidRootPart.CanCollide = false

                                        AttackNoCoolDown()

                                        PosMon = u734.HumanoidRootPart.CFrame
                                        MonFarm = u734.Name
                                        bringmob = true
                                    end)
                                until _G.Auto_MusketeerHat == false or (not u734.Parent or u734.Humanoid.Health <= 0) or game:GetService('Players').LocalPlayer.PlayerGui.Main.Quest.Visible == false
...
u19.Item:AddToggle('ToggleAutoObservationV2', {
    Title = 'Haki Quan S\u{e1}t V2',
    Description = '',
    Default = false,
}):OnChanged(function(p735)
    _G.Auto_ObservationV2 = p735
end)
            ...
            if _G.Auto_ObservationV2 then
                if game:GetService('ReplicatedStorage').Remotes.CommF_:InvokeServer('CitizenQuestProgress', 'Citizen') ~= 3 then
                    ...
                    elseif game:GetService('Players').LocalPlayer.Backpack:FindFirstChild('Fruit Bowl') or game:GetService('Players').LocalPlayer.Character:FindFirstChild('Fruit Bowl') then
                        ...
                        local v736, v737, v738 = pairs(game:GetService('Workspace'):GetDescendants())
                        ...
                        while true do
                            ...
                            if v739.Name == 'Apple' or (v739.Name == 'Banana' or v739.Name == 'Pineapple') then
                                v739.Handle.CFrame = game:GetService('Players').LocalPlayer.Character.HumanoidRootPart.CFrame * CFrame.new(0, 1, 10)

                                wait()
                                firetouchinterest(game:GetService('Players').LocalPlayer.Character.HumanoidRootPart, v739.Handle, 0)
                                wait()
                            end
                        end
                    end
...
u19.Item:AddToggle('ToggleAutoRainbowHaki', {
    Title = 'Haki 7 M\u{e0}u',
    Description = '',
    Default = false,
}):OnChanged(function(p740)
    _G.Auto_RainbowHaki = p740
end)
                    ...
                    if game:GetService('Players').LocalPlayer.PlayerGui.Main.Quest.Visible and string.find(game:GetService('Players').LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, 'Stone') then
                        if game:GetService('Workspace').Enemies:FindFirstChild('Stone') then
                            ...
                            while true do
                                ...
                                if v744.Name == 'Stone' then
                                    OldCFrameRainbow = v744.HumanoidRootPart.CFrame

                                    repeat
                                        task.wait(_G.Fast_Delay)
                                        EquipTool(SelectWeapon)
                                        Tween(v744.HumanoidRootPart.CFrame * Pos)

                                        v744.HumanoidRootPart.CanCollide = false
                                        v744.HumanoidRootPart.CFrame = OldCFrameRainbow
                                        v744.HumanoidRootPart.Size = Vector3.new(50, 50, 50)

                                        AttackNoCoolDown()
                                    until not _G.Auto_RainbowHaki or (v744.Humanoid.Health <= 0 or not v744.Parent) or not game:GetService('Players').LocalPlayer.PlayerGui.Main.Quest.Visible
                                end
                            end
                        else
                    ...
                    elseif game:GetService('Players').LocalPlayer.PlayerGui.Main.Quest.Visible and string.find(game:GetService('Players').LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, 'Hydra Leader') then
                        if game:GetService('Workspace').Enemies:FindFirstChild('Hydra Leader') then
                            ...
                            while true do
                                ...
                                if v748.Name == 'Hydra Leader' then
                                    OldCFrameRainbow = v748.HumanoidRootPart.CFrame
                                    ...
                                    repeat
                                        ...
                                        v748.HumanoidRootPart.CFrame = OldCFrameRainbow
                                        v748.HumanoidRootPart.Size = Vector3.new(50, 50, 50)

                                        AttackNoCoolDown()
                                    until not _G.Auto_RainbowHaki or (v748.Humanoid.Health <= 0 or not v748.Parent) or not game:GetService('Players').LocalPlayer.PlayerGui.Main.Quest.Visible
                                end
                            end
                        else
                    ...
                    elseif string.find(game:GetService('Players').LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, 'Kilo Admiral') then
                        if game:GetService('Workspace').Enemies:FindFirstChild('Kilo Admiral') then
                            ...
                            while true do
                                ...
                                if v752.Name == 'Kilo Admiral' then
                                    OldCFrameRainbow = v752.HumanoidRootPart.CFrame
                                    ...
                                    repeat
                                        ...
                                        v752.HumanoidRootPart.CFrame = OldCFrameRainbow

                                        AttackNoCoolDown()
                                    until not _G.Auto_RainbowHaki or (v752.Humanoid.Health <= 0 or not v752.Parent) or not game:GetService('Players').LocalPlayer.PlayerGui.Main.Quest.Visible
                                end
                            end
                        else
                    ...
                    elseif string.find(game:GetService('Players').LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, 'Captain Elephant') then
                        if game:GetService('Workspace').Enemies:FindFirstChild('Captain Elephant') then
                            ...
                            while true do
                                ...
                                if v756.Name == 'Captain Elephant' then
                                    OldCFrameRainbow = v756.HumanoidRootPart.CFrame

                                    repeat
                                        task.wait(_G.Fast_Delay)
                                        EquipTool(SelectWeapon)
                                        Tween(v756.HumanoidRootPart.CFrame * Pos)

                                        v756.HumanoidRootPart.CanCollide = false
                                        v756.HumanoidRootPart.Size = Vector3.new(50, 50, 50)
                                        v756.HumanoidRootPart.CFrame = OldCFrameRainbow

                                        AttackNoCoolDown()
                                    until not _G.Auto_RainbowHaki or (v756.Humanoid.Health <= 0 or not v756.Parent) or not game:GetService('Players').LocalPlayer.PlayerGui.Main.Quest.Visible
                                end
                            end
                        else
                    ...
                    elseif string.find(game:GetService('Players').LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, 'Beautiful Pirate') then
                        if game:GetService('Workspace').Enemies:FindFirstChild('Beautiful Pirate') then
                            ...
                            while true do
                                ...
                                if v760.Name == 'Beautiful Pirate' then
                                    OldCFrameRainbow = v760.HumanoidRootPart.CFrame
                                    ...
                                    repeat
                                        ...
                                        v760.HumanoidRootPart.Size = Vector3.new(50, 50, 50)
                                        v760.HumanoidRootPart.CFrame = OldCFrameRainbow

                                        AttackNoCoolDown()
                                    until not _G.Auto_RainbowHaki or (v760.Humanoid.Health <= 0 or not v760.Parent) or not game:GetService('Players').LocalPlayer.PlayerGui.Main.Quest.Visible
                                end
                            end
                        else
...
u19.Item:AddToggle('ToggleAutoSkullGuitar', {
    Title = 'Skull Guitar',
    Description = '',
    Default = false,
}):OnChanged(function(p761)
    _G.Auto_SkullGuitar = p761
end)
                ...
                elseif game:GetService('Workspace').Map['Haunted Castle'].Placard1.Left.Part.Transparency ~= 0 then
                    if game:GetService('Workspace').Map['Haunted Castle'].Tablet.Segment1:FindFirstChild('ClickDetector') then
                        ...
                        if game.Workspace.Enemies:FindFirstChild('Living Zombie') then
                            local v762, v763, v764 = pairs(game.Workspace.Enemies:GetChildren())
                            ...
                            while true do
                                ...
                                if v765:FindFirstChild('HumanoidRootPart') and (v765:FindFirstChild('Humanoid') and (v765.Humanoid.Health > 0 and v765.Name == 'Living Zombie')) then
                                    EquipTool(SelectWeapon)

                                    v765.HumanoidRootPart.Size = Vector3.new(60, 60, 60)
                                    v765.HumanoidRootPart.Transparency = 1
                                    v765.Humanoid.JumpPower = 0
                                    v765.Humanoid.WalkSpeed = 0
                                    v765.HumanoidRootPart.CanCollide = false
                                    v765.HumanoidRootPart.CFrame = game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame * CFrame.new(0, 20, 0)
...
u19.Item:AddToggle('ToggleAutoBuddy', {
...
local u767 = CFrame.new(-731.2034301757813, 381.5658874511719, -11198.4951171875)
            ...
            pcall(function()
                if game:GetService('Workspace').Enemies:FindFirstChild('Cake Queen') then
                    ...
                    while true do
                        ...
                        if v771.Name == 'Cake Queen' and (v771:FindFirstChild('Humanoid') and (v771:FindFirstChild('HumanoidRootPart') and v771.Humanoid.Health > 0)) then
                            repeat
                                task.wait(_G.Fast_Delay)
                                AutoHaki()
                                EquipTool(SelectWeapon)
                                ...
                                v771.HumanoidRootPart.Size = Vector3.new(50, 50, 50)

                                Tween(v771.HumanoidRootPart.CFrame * Pos)
                                AttackNoCoolDown()
                            until not _G.Auto_Buddy or (not v771.Parent or v771.Humanoid.Health <= 0)
                        end
                    end
                elseif (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - u767.Position).Magnitude < 1500 then
                    Tween(u767)
                end
...
u19.Item:AddToggle('ToggleAutoDualKatana', {
    Title = 'Song Ki\u{1ebf}m',
    Description = '',
    Default = false,
}):OnChanged(function(p772)
    _G.Auto_DualKatana = p772
end)
                                        ...
                                        if GetMaterial('Alucard Fragment') == 6 then
                                            if game:GetService('Workspace').Enemies:FindFirstChild('Cursed Skeleton Boss [Lv. 2025] [Boss]') or game:GetService('Workspace').ReplicatedStorage:FindFirstChild('Cursed Skeleton Boss [Lv. 2025] [Boss]') then
                                                ...
                                                if game:GetService('Workspace').Enemies:FindFirstChild('Cursed Skeleton Boss [Lv. 2025] [Boss]') or game:GetService('Workspace').Enemies:FindFirstChild('Cursed Skeleton [Lv. 2200]') then
                                                    local v773, v774, v775 = pairs(game:GetService('Workspace').Enemies:GetChildren())
                                                    ...
                                                    while true do
                                                        ...
                                                        if (v776.Name == 'Cursed Skeleton Boss' or v776.Name == 'Cursed Skeleton') and v776.Humanoid.Health > 0 then
                                                            EquipTool(Sword)
                                                            Tween(v776.HumanoidRootPart.CFrame * pos)

                                                            v776.HumanoidRootPart.Size = Vector3.new(60, 60, 60)
                                                            v776.HumanoidRootPart.Transparency = 1
                                                            v776.Humanoid.JumpPower = 0
                                                            v776.Humanoid.WalkSpeed = 0
                                                            v776.HumanoidRootPart.CanCollide = false
                                                            bringmob = true
                                                            FarmPos = v776.HumanoidRootPart.CFrame
                                                            MonFarm = v776.Name
            ...
            pcall(function()
                if game:GetService('Workspace').Enemies:FindFirstChild('Mythological Pirate') then
                    ...
                    while true do
                        ...
                        if v780.Name == 'Mythological Pirate' then
                            repeat
                                wait()
                                Tween(v780.HumanoidRootPart.CFrame * CFrame.new(0, 0, -2))
        ...
        pcall(function()
            if Auto_Quest_Yama_2 then
                ...
                while true do
                    ...
                    if v784:FindFirstChild('HazeESP') then
                        v784.HazeESP.Size = UDim2.new(50, 50, 50, 50)
                        v784.HazeESP.MaxDistance = 'inf'
                    end
                end
                ...
                while true do
                    ...
                    if v788:FindFirstChild('HazeESP') then
                        v788.HazeESP.Size = UDim2.new(50, 50, 50, 50)
                        v788.HazeESP.MaxDistance = 'inf'
                    end
                end
            end
        end)
    ...
    while wait() do
        pcall(function()
            ...
            while true do
                ...
                if Auto_Quest_Yama_2 and (v792:FindFirstChild('HazeESP') and (v792.HumanoidRootPart.Position - FarmPossEsp.Position).magnitude <= 300) then
                    v792.HumanoidRootPart.CFrame = FarmPossEsp
                    v792.HumanoidRootPart.CanCollide = false
                    v792.HumanoidRootPart.Size = Vector3.new(50, 50, 50)

                    if not v792.HumanoidRootPart:FindFirstChild('BodyVelocity') then
                        local _BodyVelocity2 = Instance.new('BodyVelocity', v792.HumanoidRootPart)
...
spawn(function()
    while wait() do
        if Auto_Quest_Yama_2 then
            pcall(function()
                local v794, v795, v796 = pairs(game:GetService('Workspace').Enemies:GetChildren())
                ...
                while true do
                    while true do
                        ...
                        if v797:FindFirstChild('HazeESP') then
                            break
                        end

                        local v798, v799, v800 = pairs(game:GetService('ReplicatedStorage'):GetChildren())
                        ...
                        while true do
                            ...
                            if v801:FindFirstChild('HazeESP') then
                                if (v801.HumanoidRootPart.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 2000 then
                                    Tween(v801.HumanoidRootPart.CFrame * Pos)
                                else
                                    Tween(v801.HumanoidRootPart.CFrameMon * Pos)
                                end
                            end
                        end
                    end
                    ...
                    if true then
                        ...
                        if (v797.HumanoidRootPart.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 2000 then
                            EquipTool(Sword)
                            Tween(v797.HumanoidRootPart.CFrame * Pos)

                            v797.HumanoidRootPart.Size = Vector3.new(60, 60, 60)
                            v797.HumanoidRootPart.Transparency = 1
                            v797.Humanoid.JumpPower = 0
                            v797.Humanoid.WalkSpeed = 0
                            v797.HumanoidRootPart.CanCollide = false
                            FarmPos = v797.HumanoidRootPart.CFrame
                            MonFarm = v797.Name

                            AttackNoCoolDown()

                            if v797.Humanoid.Health <= 0 and v797.Humanoid:FindFirstChild('Animator') then
                                v797.Humanoid.Animator:Destroy()
                            end
                        else
                            Tween(v797.HumanoidRootPart.CFrame * Pos)
                        end
                    end
                    if _G.Auto_DualKatana ~= false and (Auto_Quest_Yama_2 ~= false and (v797.Parent and (v797.Humanoid.Health > 0 and v797:FindFirstChild('HazeESP')))) then
                        break
                    end
                end
            end)
    ...
    while wait() do
        if Auto_Quest_Yama_3 then
            pcall(function()
                    ...
                    if game:GetService('Workspace').Enemies:FindFirstChild('Soul Reaper') or game.ReplicatedStorage:FindFirstChild('Soul Reaper [Lv. 2100] [Raid Boss]') then
                        if game:GetService('Workspace').Enemies:FindFirstChild('Soul Reaper') then
                            ...
                            while true do
                                ...
                                if v805.Name == 'Soul Reaper' and v805.Humanoid.Health > 0 then
                                    repeat
                                        wait()
                                        Tween(v805.HumanoidRootPart.CFrame * Pos)
                ...
                if v809.Name ~= 'Cursed Skeleton' and (v809.Name ~= 'Cursed Skeleton' and v809.Name ~= "Hell's Messenger") or v809.Humanoid.Health <= 0 then
                end

                wait()
                EquipTool(Sword)
                Tween(v809.HumanoidRootPart.CFrame * Pos)
                ...
                FarmPos = v809.HumanoidRootPart.CFrame
                MonFarm = v809.Name

                AttackNoCoolDown()

                if v809.Humanoid.Health <= 0 and v809.Humanoid:FindFirstChild('Animator') then
                    v809.Humanoid.Animator:Destroy()
                end
                if v809.Humanoid.Health <= 0 or (not v809.Parent or Auto_Quest_Yama_3 == false) then
                else
                end
            end)
        end
    ...
    while wait() do
        if Auto_Quest_Tushita_2 then
            pcall(function()
                ...
                local v810, v811, v812 = pairs(game:GetService('Workspace').Enemies:GetChildren())

                wait()
                EquipTool(Sword)
                Tween(v813.HumanoidRootPart.CFrame * Pos)

                v813.HumanoidRootPart.Size = Vector3.new(60, 60, 60)
                v813.HumanoidRootPart.Transparency = 1
                v813.Humanoid.JumpPower = 0
                v813.Humanoid.WalkSpeed = 0
                v813.HumanoidRootPart.CanCollide = false
                FarmPos = v813.HumanoidRootPart.CFrame
                MonFarm = v813.Name

                AttackNoCoolDown()

                if v813.Humanoid.Health <= 0 and v813.Humanoid:FindFirstChild('Animator') then
                    v813.Humanoid.Animator:Destroy()
                end
                if v813.Humanoid.Health > 0 and (v813.Parent and Auto_Quest_Tushita_2 ~= false) then
                end
                ...
                if Auto_Quest_Tushita_2 and (v813:FindFirstChild('HumanoidRootPart') and (v813:FindFirstChild('Humanoid') and (v813.Humanoid.Health > 0 and (v813.HumanoidRootPart.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude < 2000))) then
                else
                end
            end)
        end
    ...
    while wait() do
        if Auto_Quest_Tushita_3 then
            pcall(function()
                ...
                if v817.Name ~= 'Cake Queen' or v817.Humanoid.Health <= 0 then
                end

                while true do
                    wait()
                    EquipTool(Sword)
                    Tween(v817.HumanoidRootPart.CFrame * Pos)
                    ...
                    FarmPos = v817.HumanoidRootPart.CFrame
                    MonFarm = v817.Name

                    AttackNoCoolDown()

                    if v817.Humanoid.Health <= 0 and v817.Humanoid:FindFirstChild('Animator') then
                        v817.Humanoid.Animator:Destroy()
                    end
                ...
                local v818, v819 = v820(v821, v818)

                if v818 == nil then
                end
                if v819.Name ~= 'Cursed Skeleton' and (v819.Name ~= 'Cursed Skeleton' and v819.Name ~= "Heaven's Guardian") or v819.Humanoid.Health <= 0 then
                end

                wait()
                EquipTool(Sword)
                Tween(v819.HumanoidRootPart.CFrame * Pos)

                v819.HumanoidRootPart.Size = Vector3.new(60, 60, 60)
                v819.HumanoidRootPart.Transparency = 1
                v819.Humanoid.JumpPower = 0
                v819.Humanoid.WalkSpeed = 0
                v819.HumanoidRootPart.CanCollide = false
                FarmPos = v819.HumanoidRootPart.CFrame
                MonFarm = v819.Name

                AttackNoCoolDown()

                if v819.Humanoid.Health <= 0 and v819.Humanoid:FindFirstChild('Animator') then
                    v819.Humanoid.Animator:Destroy()
                end
                if v819.Humanoid.Health <= 0 or (not v819.Parent or Auto_Quest_Tushita_3 == false) then
                else
                end
                ...
                v820, v821, v818 = pairs(game:GetService('Workspace').Enemies:GetChildren())
...
if Sea2 then
    u19.Item:AddToggle('ToggleFactory', {
    ...
    spawn(function()
        ...
        local v823, v824, v825 = pairs(game.Workspace.Enemies:GetChildren())

        if v826.Name == 'Core' and v826.Humanoid.Health > 0 then
        end
        ...
        EquipTool(SelectWeapon)
        AutoHaki()
        Tween(v826.HumanoidRootPart.CFrame * Pos)

        v826.HumanoidRootPart.Size = Vector3.new(60, 60, 60)
        v826.HumanoidRootPart.Transparency = 1
        v826.Humanoid.JumpPower = 0
        v826.Humanoid.WalkSpeed = 0
        v826.HumanoidRootPart.CanCollide = false
        FarmPos = v826.HumanoidRootPart.CFrame
        MonFarm = v826.Name

        if v826.Parent and (v826.Humanoid.Health > 0 and _G.Factory ~= false) then
        end
    end)
end

u19.Item:AddToggle('ToggleAutoFarmSwan', {
    Title = '\u{fffd}\u{e1}nh Swan',
    Description = '',
    Default = false,
}):OnChanged(function(p827)
    _G.Auto_FarmSwan = p827
end)
            ...
            if _G.AutoFarmSwan then
                if game:GetService('Workspace').Enemies:FindFirstChild('Don Swan') then
                    ...
                    while true do
                        ...
                        v830, u831 = v828(v829, v830)

                        if v830 == nil then
                            break
                        end
                        if u831.Name == 'Don Swan' and (u831.Humanoid.Health > 0 and (u831:IsA('Model') and (u831:FindFirstChild('Humanoid') and u831:FindFirstChild('HumanoidRootPart')))) then
                            repeat
                                task.wait()
                                pcall(function()
                                    AutoHaki()
                                    ...
                                    u831.HumanoidRootPart.CanCollide = false
                                    u831.HumanoidRootPart.Size = Vector3.new(50, 50, 50)

                                    Tween(u831.HumanoidRootPart.CFrame * Pos)
                                    AttackNoCoolDown()
                                end)
                            until _G.AutoFarmSwan == false or u831.Humanoid.Health <= 0
                        end
                    end
                else
                    repeat
...
u19.Item:AddToggle('ToggleAutoRengoku', {
    Title = 'Rengoku',
    Description = '',
    Default = false,
        ...
        while wait() do
            if _G.Auto_Regoku then
                ...
                elseif game:GetService('Workspace').Enemies:FindFirstChild('Snow Lurker') or game:GetService('Workspace').Enemies:FindFirstChild('Arctic Warrior') then
                    local v833, v834, v835 = pairs(game:GetService('Workspace').Enemies:GetChildren())
                    ...
                    while true do
                        ...
                        if (v836.Name == 'Snow Lurker' or v836.Name == 'Arctic Warrior') and v836.Humanoid.Health > 0 then
                            repeat
                                task.wait(_G.Fast_Delay)
                                EquipTool(SelectWeapon)
                                AutoHaki()
                                ...
                                v836.HumanoidRootPart.Size = Vector3.new(50, 50, 50)
                                FarmPos = v836.HumanoidRootPart.CFrame
                                MonFarm = v836.Name

                                Tween(v836.HumanoidRootPart.CFrame * Pos)
                                AttackNoCoolDown()

                                bringmob = true
                            until game:GetService('Players').LocalPlayer.Backpack:FindFirstChild('Hidden Key') or (_G.Auto_Regoku == false or (not v836.Parent or v836.Humanoid.Health <= 0))
...
if Sea2 or Sea3 then
    u19.Item:AddToggle('ToggleHakiColor', {
        Title = 'Mua M\u{e0}u Haki',
        Description = '',
        Default = false,
    }):OnChanged(function(p837)
        _G.Auto_Buy_Enchancement = p837
    end)
...
if Sea2 then
    u19.Main:AddToggle('ToggleEvoRace', {
                                                ...
                                                while true do
                                                    ...
                                                    if v843.Name == 'Zombie' then
                                                        repeat
                                                            ...
                                                            v843.HumanoidRootPart.Size = Vector3.new(50, 50, 50)
                                                            ...
                                                            MonFarm = v843.Name
                                                            bringmob = true
                                                        until game:GetService('Players').LocalPlayer.Backpack:FindFirstChild('Flower 3') or (not v843.Parent or (v843.Humanoid.Health <= 0 or _G.AutoEvoRace == false))
...
u19.Setting:AddToggle('ToggleAutoT', {
    Title = 'B\u{1ead}t T\u{1ed9}c V3',
    Description = '',
    Default = false,
}):OnChanged(function(p844)
    _G.AutoT = p844
end)
...
u19.Setting:AddToggle('ToggleAutoY', {
...
u19.Setting:AddToggle('ToggleAutoKen', {
    Title = 'B\u{1ead}t Haki Quan S\u{e1}t',
    Description = '',
    Default = false,
}):OnChanged(function(p846)
    _G.AutoKen = p846
...
u19.Setting:AddToggle('ToggleSaveSpawn', {
    Title = 'L\u{1b0}u \u{110}i\u{1ec3}m H\u{1ed3}i Sinh',
    Description = '',
    Default = false,
}):OnChanged(function(p847)
    _G.SaveSpawn = p847
...
u19.Setting:AddButton({
    Title = 'Fps Boost',
    Description = '',
    Callback = function()
        local v848 = game
        local _Workspace2 = v848.Workspace
        local _Lighting = v848.Lighting
        ...
        local v852, v853, v854 = pairs(v848:GetDescendants())
        local v855 = false
        ...
        while true do
            ...
            if v856:IsA('Part') or (v856:IsA('Union') or (v856:IsA('CornerWedgePart') or v856:IsA('TrussPart'))) then
                v856.Material = 'Plastic'
                v856.Reflectance = 0
            elseif v856:IsA('Decal') or v856:IsA('Texture') and v855 then
                v856.Transparency = 1
            elseif v856:IsA('ParticleEmitter') or v856:IsA('Trail') then
                v856.Lifetime = NumberRange.new(0)
            elseif v856:IsA('Explosion') then
                v856.BlastPressure = 1
                v856.BlastRadius = 1
            elseif v856:IsA('Fire') or (v856:IsA('SpotLight') or (v856:IsA('Smoke') or v856:IsA('Sparkles'))) then
                v856.Enabled = false
            elseif v856:IsA('MeshPart') then
                v856.Material = 'Plastic'
                v856.Reflectance = 0
                v856.TextureID = 1.0385902758728955e16
            end
        end

        local v857, v858, v859 = pairs(_Lighting:GetChildren())
        ...
        while true do
            ...
            if v860:IsA('BlurEffect') or (v860:IsA('SunRaysEffect') or (v860:IsA('ColorCorrectionEffect') or (v860:IsA('BloomEffect') or v860:IsA('DepthOfFieldEffect')))) then
                v860.Enabled = false
            end
        end
    end,
})
u19.Setting:AddToggle('ToggleRemoveNotify', {
...
u19.Setting:AddToggle('ToggleWhite', {
...
u19.Setting:AddSection('K\u{129} N\u{103}ng Th\u{f4}ng Th\u{1ea1}o')
u19.Setting:AddToggle('ToggleZ', {
...
local u868 = u19.Status:AddParagraph({
...
local u879 = u19.Status:AddParagraph({
...
local u885 = u19.Status:AddParagraph({
...
u19.Stats:AddToggle('ToggleMelee', {
    Title = 'N\u{e2}ng \u{110}\u{e1}nh',
    Description = '',
    Default = false,
...
u19.Stats:AddToggle('ToggleSword', {
...
u19.Stats:AddToggle('ToggleFruit', {
...
local _SelectedPly = u19.Player:AddDropdown('SelectedPly', {
...
u19.Player:AddToggle('ToggleTeleport', {
...
u19.Player:AddToggle('ToggleWalkonWater', {
...
u19.Player:AddToggle('ToggleSpeedRun', {
...
u19.Player:AddToggle('ToggleNoClip', {
...
u19.Player:AddToggle('ToggleEnablePvp', {
...
local _ThGii = u19.Teleport:AddSection('Th\u{1ebf} Gi\u{1edb}i')

u19.Teleport:AddToggle('ToggleAutoSea2', {
...
u19.Teleport:AddToggle('ToggleAutoSea3', {
...
u19.Teleport:AddSection('\u{fffd}\u{1ea3}o')
...
local _DropdownIsland = u19.Teleport:AddDropdown('DropdownIsland', {
...
u19.Visual:AddInput('Input_Level', {
    Title = 'C\u{1ea5}p',
    Default = '',
...
u19.Visual:AddInput('Input_Beli', {
    Title = 'Ti\u{1ec1}n',
    Default = '',
    Placeholder = 'Nh\u{1ead}p',
    Numeric = false,
...
u19.Visual:AddInput('Input_Fragments', {
...
local _DropdownFruit = u19.Fruit:AddDropdown('DropdownFruit', {
...
u19.Fruit:AddToggle('ToggleFruit', {
...
local _DropdownPermanentFruit = u19.Fruit:AddDropdown('DropdownPermanentFruit', {
...
u19.Fruit:AddToggle('TogglePermanentFruit', {
...
u19.Fruit:AddToggle('ToggleStore', {
...
u19.Fruit:AddToggle('ToggleRandomFruit', {
...
u19.Fruit:AddToggle('ToggleCollectTP', {
...
u19.Fruit:AddToggle('ToggleCollect', {
...
u19.Fruit:AddSection('\u{fffd}\u{1ecb}nh V\u{1ecb}')
u19.Fruit:AddToggle('ToggleEspPlayer', {
...
u19.Fruit:AddToggle('ToggleEspFruit', {
    Title = 'Tr\u{e1}i',
    Description = '',
    Default = false,
...
u19.Fruit:AddToggle('ToggleEspIsland', {
...
u19.Fruit:AddToggle('ToggleEspFlower', {
    Title = 'Hoa',
    Description = '',
    Default = false,
...
u19.Fruit:AddToggle('ToggleEspRealFruit', {
...
u19.Fruit:AddToggle('ToggleIslandMirageEsp', {
...
local _DropdownRaid = u19.Raid:AddDropdown('DropdownRaid', {
...
u19.Raid:AddToggle('ToggleStart', {
...
u19.Raid:AddToggle('ToggleNextIsland', {
    Title = '\u{fffd}\u{e1}nh Qu\u{e1}i Raid+Bay Qua \u{110}\u{1ea3}o',
    Description = '',
    Default = false,
...
u19.Raid:AddToggle('ToggleAwake', {
...
u19.Raid:AddToggle('ToggleGetFruit', {
...
u19.Raid:AddSection('T\u{1ead}p K\u{ed}ch Law')
u19.Raid:AddToggle('ToggleLaw', {
...
u19.Race:AddSection('T\u{1ed9}c')
u19.Race:AddButton({
...
u19.Race:AddToggle('ToggleHumanandghoul', {
...
u19.Race:AddToggle('ToggleAutotrial', {
...
u19.Race:AddToggle('ToggleKillTrial', {
...
u19.Race:AddSection('Hu\u{1ea5}n Luy\u{1ec7}n')

local _ToggleFarmRace = u19.Race:AddToggle('ToggleFarmRace', {
    Title = 'C\u{e0}y Luy\u{1ec7}n T\u{1ed9}c',
    Description = 'T\u{ed}ch N\u{1ed9} V\u{e0} Bi\u{1ebf}n V4',
    Default = false,
})
local u1060 = false
...
u19.Race:AddToggle('ToggleUpgrade', {
    Title = 'Mua Gear',
    Description = '',
    Default = false,
...
u19.Shop:AddSection('Kh\u{1ea3} N\u{103}ng')
u19.Shop:AddButton({
    Title = 'Geppo',
    Description = '',
    Callback = function()
...
u19.Shop:AddSection('Ki\u{1ebf}m')
u19.Shop:AddButton({
    Title = 'Cutlass',
    Description = '',
    Callback = function()
...
u19.Shop:AddSection('Ph\u{1ee5} Ki\u{1ec7}n')
u19.Shop:AddButton({
    Title = 'Black Cape',
    Description = '',
    Callback = function()
...
u19.Misc:AddSection('\u{fffd}\u{1ed9}i')
u19.Misc:AddButton({
...
u19.Misc:AddSection('Kinh Nghi\u{1ec7}m')
...
u19.Misc:AddSection('Danh Hi\u{1ec7}u')
u19.Misc:AddButton({
...
u19.Misc:AddSection('Th\u{1ee9}c T\u{1ec9}nh')
u19.Misc:AddButton({
    Title = 'Th\u{1ee9}c T\u{1ec9}nh',
    Description = '',
    Callback = function()
...
u19.Misc:AddSection('Kh\u{e1}c')
u19.Misc:AddToggle('ToggleRejoin', {
    Title = 'Tham Gia M\u{e1}y Ch\u{1ee7} L\u{1ea1}i',
    Description = '',
    Default = true,
...
u19.Misc:AddSection('S\u{1b0}\u{1a1}ng')
...
u19.Misc:AddToggle('ToggleAntiBand', {
...
local _ToggleTPFrozenDimension = u19.Sea:AddToggle('ToggleTPFrozenDimension', {
...
if Sea3 then
    local u1102 = u19.Sea:AddParagraph({
...
u19.Sea:AddSection('Draco')
u19.Sea:AddToggle('ToggleBlazeEmber', {
    Title = 'Nh\u{1eb7}t L\u{1eed}a \u{110}\u{1ecf}',
    Description = '',
    Default = false,
...
u19.Sea:AddToggle('ToggleBlazeEmberFarm', {
...
u19.Sea:AddToggle('ToggleReceiveQuest', {
...
local u1112 = u19.Sea:AddParagraph({
...
u19.Sea:AddToggle('ToggleHydraTree', {
...
local function u1121(p1119)
    ...
    _VirtualInputManager3:SendKeyEvent(true, p1119, false, game)
    _VirtualInputManager3:SendKeyEvent(false, p1119, false, game)
end
...
u19.Sea:AddToggle('ToggleCollectFireFlowers', {
    Title = 'Nh\u{1eb7}t Hoa \u{110}\u{1ecf}',
    Description = '',
    Default = false,
...
u19.Sea:AddToggle('ToggleWhiteBelt', {
...
u19.Sea:AddSection('\u{fffd}\u{1ea3}o Dung Nham')

local u1150 = u19.Sea:AddParagraph({
...
u19.Sea:AddToggle('ToggleTPVolcano', {
...
u19.Sea:AddToggle('ToggleDefendVolcano', {
...
u19.Sea:AddToggle('ToggleKillAura', {
...
u19.Sea:AddToggle('ToggleCollectBone', {
    Title = 'Nh\u{1eb7}t X\u{1b0}\u{1a1}ng',
    Description = '',
    Default = false,
...
u19.Sea:AddToggle('ToggleCollectEgg', {
    Title = 'Nh\u{1eb7}t Tr\u{1ee9}ng',
    Description = '',
    Default = false,
...
setclipboard('Link Sever Discord Tu\u{1ea5}n Anh IOS  |  https://discord.gg/kK2vMrUsQy')
