...
elseif _PlaceId == 7449423635 then
    ...
    warn('Script loaded but current place ID is not supported: ' .. tostring(_PlaceId))
end
...
function CheckLevel()
    ...
    if Sea1 then
        if (_Value >= 1 and _Value <= 9) or SelectMonster == 'Bandit' then
            Ms = 'Bandit'
        ...
        elseif (_Value >= 10 and _Value <= 14) or SelectMonster == 'Monkey' then
            Ms = 'Monkey'
        ...
        elseif (_Value >= 15 and _Value <= 29) or SelectMonster == 'Gorilla' then
            Ms = 'Gorilla'
            NameQuest = 'JungleQuest'
            QuestLv = 2
            NameMon = 'Gorilla'
        ...
        elseif (_Value >= 30 and _Value <= 39) or SelectMonster == 'Pirate' then
            Ms = 'Pirate'
        ...
        elseif (_Value >= 40 and _Value <= 59) or SelectMonster == 'Brute' then
            Ms = 'Brute'
            NameQuest = 'BuggyQuest1'
            QuestLv = 2
            NameMon = 'Brute'
        ...
        elseif (_Value >= 60 and _Value <= 74) or SelectMonster == 'Desert Bandit' then
            Ms = 'Desert Bandit'
        ...
        elseif (_Value >= 75 and _Value <= 89) or SelectMonster == 'Desert Officer' then
            Ms = 'Desert Officer'
            NameQuest = 'DesertQuest'
            QuestLv = 2
        ...
        elseif (_Value >= 90 and _Value <= 99) or SelectMonster == 'Snow Bandit' then
            Ms = 'Snow Bandit'
            NameQuest = 'SnowQuest'
            QuestLv = 1
            NameMon = 'Snow Bandit'
        ...
        elseif (_Value >= 100 and _Value <= 119) or SelectMonster == 'Snowman' then
            Ms = 'Snowman'
            NameQuest = 'SnowQuest'
            QuestLv = 2
            NameMon = 'Snowman'
        ...
        elseif (_Value >= 120 and _Value <= 149) or SelectMonster == 'Chief Petty Officer' then
        ...
        elseif (_Value >= 150 and _Value <= 174) or SelectMonster == 'Sky Bandit' then
            Ms = 'Sky Bandit'
            NameQuest = 'SkyQuest'
            QuestLv = 1
            NameMon = 'Sky Bandit'
        ...
        elseif (_Value >= 175 and _Value <= 189) or SelectMonster == 'Dark Master' then
            Ms = 'Dark Master'
            NameQuest = 'SkyQuest'
            QuestLv = 2
            NameMon = 'Dark Master'
        ...
        elseif (_Value >= 190 and _Value <= 209) or SelectMonster == 'Prisoner' then
            Ms = 'Prisoner'
        ...
        elseif (_Value >= 210 and _Value <= 249) or SelectMonster == 'Dangerous Prisoner' then
        ...
        elseif (_Value >= 250 and _Value <= 274) or SelectMonster == 'Toga Warrior' then
            Ms = 'Toga Warrior'
        ...
        elseif (_Value >= 275 and _Value <= 299) or SelectMonster == 'Gladiator' then
            Ms = 'Gladiator'
            NameQuest = 'ColosseumQuest'
            QuestLv = 2
            NameMon = 'Gladiator'
        ...
        elseif (_Value >= 300 and _Value <= 324) or SelectMonster == 'Military Soldier' then
            Ms = 'Military Soldier'
        ...
        elseif (_Value >= 325 and _Value <= 374) or SelectMonster == 'Military Spy' then
            Ms = 'Military Spy'
            NameQuest = 'MagmaQuest'
            QuestLv = 2
        ...
        elseif (_Value >= 375 and _Value <= 399) or SelectMonster == 'Fishman Warrior' then
            Ms = 'Fishman Warrior'
        ...
        elseif (_Value >= 400 and _Value <= 449) or SelectMonster == 'Fishman Commando' then
            Ms = 'Fishman Commando'
            NameQuest = 'FishmanQuest'
            QuestLv = 2
        ...
        elseif (_Value >= 475 and _Value <= 524) or SelectMonster == 'Shanda' then
            Ms = 'Shanda'
            NameQuest = 'SkyExp1Quest'
            QuestLv = 2
            NameMon = 'Shanda'
        ...
        elseif (_Value >= 525 and _Value <= 549) or SelectMonster == 'Royal Squad' then
            Ms = 'Royal Squad'
        ...
        elseif (_Value >= 550 and _Value <= 624) or SelectMonster == 'Royal Soldier' then
            Ms = 'Royal Soldier'
            NameQuest = 'SkyExp2Quest'
            QuestLv = 2
        ...
        elseif (_Value >= 625 and _Value <= 649) or SelectMonster == 'Galley Pirate' then
            Ms = 'Galley Pirate'
    ...
    if Sea2 then
        if (_Value >= 700 and _Value <= 724) or SelectMonster == 'Raider' then
            Ms = 'Raider'
        ...
        elseif (_Value >= 725 and _Value <= 774) or SelectMonster == 'Mercenary' then
            Ms = 'Mercenary'
            NameQuest = 'Area1Quest'
            QuestLv = 2
            NameMon = 'Mercenary'
        ...
        elseif (_Value >= 775 and _Value <= 799) or SelectMonster == 'Swan Pirate' then
            Ms = 'Swan Pirate'
        ...
        elseif (_Value >= 800 and _Value <= 874) or SelectMonster == 'Factory Staff' then
            Ms = 'Factory Staff'
            NameQuest = 'Area2Quest'
            QuestLv = 2
        ...
        elseif (_Value >= 875 and _Value <= 899) or SelectMonster == 'Marine Lieutenan' then
        ...
        elseif (_Value >= 900 and _Value <= 949) or SelectMonster == 'Marine Captain' then
            Ms = 'Marine Captain'
            NameQuest = 'MarineQuest3'
            QuestLv = 2
        ...
        elseif (_Value >= 950 and _Value <= 974) or SelectMonster == 'Zombie' then
            Ms = 'Zombie'
        ...
        elseif (_Value >= 975 and _Value <= 999) or SelectMonster == 'Vampire' then
            Ms = 'Vampire'
            NameQuest = 'ZombieQuest'
            QuestLv = 2
            NameMon = 'Vampire'
        ...
        elseif (_Value >= 1000 and _Value <= 1049) or SelectMonster == 'Snow Trooper' then
            Ms = 'Snow Trooper'
        ...
        elseif (_Value >= 1050 and _Value <= 1099) or SelectMonster == 'Winter Warrior' then
            Ms = 'Winter Warrior'
            NameQuest = 'SnowMountainQuest'
            QuestLv = 2
        ...
        elseif (_Value >= 1100 and _Value <= 1124) or SelectMonster == 'Lab Subordinate' then
            Ms = 'Lab Subordinate'
        ...
        elseif (_Value >= 1125 and _Value <= 1174) or SelectMonster == 'Horned Warrior' then
            Ms = 'Horned Warrior'
            NameQuest = 'IceSideQuest'
            QuestLv = 2
        ...
        elseif (_Value >= 1175 and _Value <= 1199) or SelectMonster == 'Magma Ninja' then
            Ms = 'Magma Ninja'
        ...
        elseif (_Value >= 1200 and _Value <= 1249) or SelectMonster == 'Lava Pirate' then
            Ms = 'Lava Pirate'
            NameQuest = 'FireSideQuest'
            QuestLv = 2
            NameMon = 'Lava Pirate'
        ...
        elseif (_Value >= 1250 and _Value <= 1274) or SelectMonster == 'Ship Deckhand' then
            Ms = 'Ship Deckhand'
        ...
        elseif (_Value >= 1275 and _Value <= 1299) or SelectMonster == 'Ship Engineer' then
            Ms = 'Ship Engineer'
            NameQuest = 'ShipQuest1'
            QuestLv = 2
        ...
        elseif (_Value >= 1300 and _Value <= 1324) or SelectMonster == 'Ship Steward' then
            Ms = 'Ship Steward'
        ...
        elseif (_Value >= 1325 and _Value <= 1349) or SelectMonster == 'Ship Officer' then
            Ms = 'Ship Officer'
            NameQuest = 'ShipQuest2'
            QuestLv = 2
        ...
        elseif (_Value >= 1350 and _Value <= 1374) or SelectMonster == 'Arctic Warrior' then
            Ms = 'Arctic Warrior'
        ...
        elseif (_Value >= 1375 and _Value <= 1424) or SelectMonster == 'Snow Lurker' then
            Ms = 'Snow Lurker'
            NameQuest = 'FrostQuest'
            QuestLv = 2
            NameMon = 'Snow Lurker'
        ...
        elseif (_Value >= 1425 and _Value <= 1449) or SelectMonster == 'Sea Soldier' then
            Ms = 'Sea Soldier'
    ...
    if Sea3 then
        if (_Value >= 1500 and _Value <= 1524) or SelectMonster == 'Pirate Millionaire' then
        ...
        elseif (_Value >= 1525 and _Value <= 1574) or SelectMonster == 'Pistol Billionaire' then
        ...
        elseif (_Value >= 1575 and _Value <= 1599) or SelectMonster == 'Dragon Crew Warrior' then
        ...
        elseif (_Value >= 1600 and _Value <= 1624) or SelectMonster == 'Dragon Crew Archer' then
        ...
        elseif (_Value >= 1625 and _Value <= 1649) or SelectMonster == 'Hydra Enforcer' then
            Ms = 'Hydra Enforcer'
        ...
        elseif (_Value >= 1650 and _Value <= 1699) or SelectMonster == 'Venomous Assailant' then
        ...
        elseif (_Value >= 1700 and _Value <= 1724) or SelectMonster == 'Marine Commodore' then
            Ms = 'Marine Commodore'
        ...
        elseif (_Value >= 1725 and _Value <= 1774) or SelectMonster == 'Marine Rear Admiral' then
        ...
        elseif (_Value >= 1775 and _Value <= 1799) or SelectMonster == 'Fishman Raider' then
            Ms = 'Fishman Raider'
        ...
        elseif (_Value >= 1800 and _Value <= 1824) or SelectMonster == 'Fishman Captain' then
            Ms = 'Fishman Captain'
            NameQuest = 'DeepForestIsland3'
            QuestLv = 2
        ...
        elseif (_Value >= 1825 and _Value <= 1849) or SelectMonster == 'Forest Pirate' then
            Ms = 'Forest Pirate'
        ...
        elseif (_Value >= 1850 and _Value <= 1899) or SelectMonster == 'Mythological Pirate' then
        ...
        elseif (_Value >= 1900 and _Value <= 1924) or SelectMonster == 'Jungle Pirate' then
            Ms = 'Jungle Pirate'
        ...
        elseif (_Value >= 1925 and _Value <= 1974) or SelectMonster == 'Musketeer Pirate' then
            Ms = 'Musketeer Pirate'
            NameQuest = 'DeepForestIsland2'
            QuestLv = 2
        ...
        elseif (_Value >= 1975 and _Value <= 1999) or SelectMonster == 'Reborn Skeleton' then
            Ms = 'Reborn Skeleton'
        ...
        elseif (_Value >= 2000 and _Value <= 2024) or SelectMonster == 'Living Zombie' then
            Ms = 'Living Zombie'
            NameQuest = 'HauntedQuest1'
            QuestLv = 2
        ...
        elseif (_Value >= 2025 and _Value <= 2049) or SelectMonster == 'Demonic Soul' then
            Ms = 'Demonic Soul'
        ...
        elseif (_Value >= 2050 and _Value <= 2074) or SelectMonster == 'Posessed Mummy' then
            Ms = 'Posessed Mummy'
            NameQuest = 'HauntedQuest2'
            QuestLv = 2
        ...
        elseif (_Value >= 2075 and _Value <= 2099) or SelectMonster == 'Peanut Scout' then
            Ms = 'Peanut Scout'
        ...
        elseif (_Value >= 2100 and _Value <= 2124) or SelectMonster == 'Peanut President' then
            Ms = 'Peanut President'
            NameQuest = 'NutsIslandQuest'
            QuestLv = 2
            ...
            CFrameQ = CFrame.new(-2105.53198, 37.2495995, -10195.5088, -0.766061664, 0, -0.642767608, 0, 1, 0, 0.642767608, 0, -0.766061664)
            CFrameMon = CFrame.new(-2150.587890625, 122.49767303467, -10358.994140625)
        elseif (_Value >= 2125 and _Value <= 2149) or SelectMonster == 'Ice Cream Chef' then
            Ms = 'Ice Cream Chef'
        ...
        elseif (_Value >= 2150 and _Value <= 2199) or SelectMonster == 'Ice Cream Commander' then
            ...
            CFrameQ = CFrame.new(-819.376709, 64.9259796, -10967.2832, -0.766061664, 0, 0.642767608, 0, 1, 0, -0.642767608, 0, -0.766061664)
            CFrameMon = CFrame.new(-789.941528, 209.382889, -11009.9805, -0.0703101531, 0, -0.997525156, 0, 1.00000012, 0, 0.997525275, 0, -0.0703101456)
        elseif (_Value >= 2200 and _Value <= 2224) or SelectMonster == 'Cookie Crafter' then
            Ms = 'Cookie Crafter'
        ...
        elseif (_Value >= 2225 and _Value <= 2249) or SelectMonster == 'Cake Guard' then
            Ms = 'Cake Guard'
            NameQuest = 'CakeQuest1'
            QuestLv = 2
            NameMon = 'Cake Guard'
        ...
        elseif (_Value >= 2250 and _Value <= 2274) or SelectMonster == 'Baking Staff' then
            Ms = 'Baking Staff'
        ...
        elseif (_Value >= 2275 and _Value <= 2299) or SelectMonster == 'Head Baker' then
            Ms = 'Head Baker'
            NameQuest = 'CakeQuest2'
            QuestLv = 2
            NameMon = 'Head Baker'
        ...
        elseif (_Value >= 2300 and _Value <= 2324) or SelectMonster == 'Cocoa Warrior' then
            Ms = 'Cocoa Warrior'
        ...
        elseif (_Value >= 2325 and _Value <= 2349) or SelectMonster == 'Chocolate Bar Battler' then
        ...
        elseif (_Value >= 2350 and _Value <= 2374) or SelectMonster == 'Sweet Thief' then
            Ms = 'Sweet Thief'
        ...
        elseif (_Value >= 2375 and _Value <= 2400) or SelectMonster == 'Candy Rebel' then
            Ms = 'Candy Rebel'
            NameQuest = 'ChocQuest2'
            QuestLv = 2
            NameMon = 'Candy Rebel'
        ...
        elseif (_Value >= 2400 and _Value <= 2424) or SelectMonster == 'Candy Pirate' then
            Ms = 'Candy Pirate'
        ...
        elseif (_Value >= 2425 and _Value <= 2449) or SelectMonster == 'Snow Demon' then
            Ms = 'Snow Demon'
            NameQuest = 'CandyQuest1'
            QuestLv = 2
            NameMon = 'Snow Demon'
        ...
        elseif (_Value >= 2450 and _Value <= 2474) or SelectMonster == 'Isle Outlaw' then
            Ms = 'Isle Outlaw'
        ...
        elseif (_Value >= 2475 and _Value <= 2499) or SelectMonster == 'Island Boy' then
            Ms = 'Island Boy'
            NameQuest = 'TikiQuest1'
            QuestLv = 2
            NameMon = 'Island Boy'
        ...
        elseif (_Value >= 2500 and _Value <= 2524) or SelectMonster == 'Sun-kissed Warrior' then
            ...
            CFrameMon = CFrame.new(-16357.3125, 20.632822036743164, 1005.64892578125)
        elseif (_Value >= 2525 and _Value <= 2549) or SelectMonster == 'Isle Champion' then
            Ms = 'Isle Champion'
            NameQuest = 'TikiQuest2'
            QuestLv = 2
        ...
        elseif (_Value >= 2550 and _Value <= 2574) or SelectMonster == 'Serpent Hunter' then
            Ms = 'Serpent Hunter'
